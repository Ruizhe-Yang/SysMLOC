 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.DocumentationImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.DocumentationImpl#isIsVariant <em>Is Variant</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.DocumentationImpl#getDeclaredShortName <em>Declared Short Name</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.DocumentationImpl#getDeclaredName <em>Declared Name</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.DocumentationImpl#getLocale <em>Locale</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.DocumentationImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentationImpl extends AnnotatingElementImpl implements Documentation
{
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.DOCUMENTATION__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.DOCUMENTATION__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.DOCUMENTATION__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.DOCUMENTATION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public void setLocale(String newLocale)
  {
    ...
    locale = newLocale;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.DOCUMENTATION__LOCALE, oldLocale, locale));
  }
  ...
  public void setBody(String newBody)
  {
    ...
    body = newBody;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.DOCUMENTATION__BODY, oldBody, body));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KerMLOCPackage.DOCUMENTATION__VISIBILITY:
        return getVisibility();
      case KerMLOCPackage.DOCUMENTATION__IS_VARIANT:
        return isIsVariant();
      case KerMLOCPackage.DOCUMENTATION__DECLARED_SHORT_NAME:
        return getDeclaredShortName();
      case KerMLOCPackage.DOCUMENTATION__DECLARED_NAME:
        return getDeclaredName();
      case KerMLOCPackage.DOCUMENTATION__LOCALE:
        return getLocale();
      case KerMLOCPackage.DOCUMENTATION__BODY:
        return getBody();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case KerMLOCPackage.DOCUMENTATION__VISIBILITY: return KerMLOCPackage.MEMBER_PREFIX__VISIBILITY;
        case KerMLOCPackage.DOCUMENTATION__IS_VARIANT: return KerMLOCPackage.MEMBER_PREFIX__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (derivedFeatureID)
      {
        case KerMLOCPackage.DOCUMENTATION__DECLARED_SHORT_NAME: return KerMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME;
        case KerMLOCPackage.DOCUMENTATION__DECLARED_NAME: return KerMLOCPackage.IDENTIFICATION__DECLARED_NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case KerMLOCPackage.MEMBER_PREFIX__VISIBILITY: return KerMLOCPackage.DOCUMENTATION__VISIBILITY;
        case KerMLOCPackage.MEMBER_PREFIX__IS_VARIANT: return KerMLOCPackage.DOCUMENTATION__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (baseFeatureID)
      {
        case KerMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME: return KerMLOCPackage.DOCUMENTATION__DECLARED_SHORT_NAME;
        case KerMLOCPackage.IDENTIFICATION__DECLARED_NAME: return KerMLOCPackage.DOCUMENTATION__DECLARED_NAME;
        default: return -1;
      }
    }
