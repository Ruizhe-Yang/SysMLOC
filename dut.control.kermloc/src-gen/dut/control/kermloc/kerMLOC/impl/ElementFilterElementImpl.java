 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.ElementFilterElementImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.ElementFilterElementImpl#isIsVariant <em>Is Variant</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.ElementFilterElementImpl#getFilterExpression <em>Filter Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementFilterElementImpl extends PackageBodyElementImpl implements ElementFilterElement
{
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.ELEMENT_FILTER_ELEMENT__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.ELEMENT_FILTER_ELEMENT__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public void setFilterExpression(String newFilterExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.ELEMENT_FILTER_ELEMENT__FILTER_EXPRESSION, oldFilterExpression, filterExpression));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KerMLOCPackage.ELEMENT_FILTER_ELEMENT__VISIBILITY:
        return getVisibility();
      case KerMLOCPackage.ELEMENT_FILTER_ELEMENT__IS_VARIANT:
        return isIsVariant();
      case KerMLOCPackage.ELEMENT_FILTER_ELEMENT__FILTER_EXPRESSION:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case KerMLOCPackage.ELEMENT_FILTER_ELEMENT__VISIBILITY: return KerMLOCPackage.MEMBER_PREFIX__VISIBILITY;
        case KerMLOCPackage.ELEMENT_FILTER_ELEMENT__IS_VARIANT: return KerMLOCPackage.MEMBER_PREFIX__IS_VARIANT;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case KerMLOCPackage.MEMBER_PREFIX__VISIBILITY: return KerMLOCPackage.ELEMENT_FILTER_ELEMENT__VISIBILITY;
        case KerMLOCPackage.MEMBER_PREFIX__IS_VARIANT: return KerMLOCPackage.ELEMENT_FILTER_ELEMENT__IS_VARIANT;
        default: return -1;
      }
    }
