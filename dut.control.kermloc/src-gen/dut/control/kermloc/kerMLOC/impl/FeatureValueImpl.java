 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.FeatureValueImpl#isIsInitial <em>Is Initial</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.FeatureValueImpl#isIsDefault <em>Is Default</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.FeatureValueImpl#getValuePart <em>Value Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureValueImpl extends MinimalEObjectImpl.Container implements FeatureValue
{
  ...
  {
    return KerMLOCPackage.eINSTANCE.getFeatureValue();
  }
  ...
  public void setIsInitial(boolean newIsInitial)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.FEATURE_VALUE__IS_INITIAL, oldIsInitial, isInitial));
  }
  ...
  public void setIsDefault(boolean newIsDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.FEATURE_VALUE__IS_DEFAULT, oldIsDefault, isDefault));
  }
  ...
  public void setValuePart(String newValuePart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.FEATURE_VALUE__VALUE_PART, oldValuePart, valuePart));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KerMLOCPackage.FEATURE_VALUE__IS_INITIAL:
        return isIsInitial();
      case KerMLOCPackage.FEATURE_VALUE__IS_DEFAULT:
        return isIsDefault();
      case KerMLOCPackage.FEATURE_VALUE__VALUE_PART:
        return getValuePart();
    }
