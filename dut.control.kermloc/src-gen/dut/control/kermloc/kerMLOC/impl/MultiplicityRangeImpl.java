 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.MultiplicityRangeImpl#getMultiLow <em>Multi Low</em>}</li>
 *   <li>{@link dut.control.kermloc.kerMLOC.impl.MultiplicityRangeImpl#getMultiHigh <em>Multi High</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiplicityRangeImpl extends MinimalEObjectImpl.Container implements MultiplicityRange
{
  ...
  {
    return KerMLOCPackage.eINSTANCE.getMultiplicityRange();
  }
  ...
  public void setMultiLow(String newMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.MULTIPLICITY_RANGE__MULTI_LOW, oldMultiLow, multiLow));
  }
  ...
  public void setMultiHigh(String newMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KerMLOCPackage.MULTIPLICITY_RANGE__MULTI_HIGH, oldMultiHigh, multiHigh));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KerMLOCPackage.MULTIPLICITY_RANGE__MULTI_LOW:
        return getMultiLow();
      case KerMLOCPackage.MULTIPLICITY_RANGE__MULTI_HIGH:
        return getMultiHigh();
    }
