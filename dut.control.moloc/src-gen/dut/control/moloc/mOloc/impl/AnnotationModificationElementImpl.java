...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Modification Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getParameterType <em>Parameter Type</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getDirectionType <em>Direction Type</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getDeclarationName <em>Declaration Name</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getElementName <em>Element Name</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#isIsConstrainedby <em>Is Constrainedby</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#getConstrain <em>Constrain</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#isIsRedeclare <em>Is Redeclare</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#isIsEach <em>Is Each</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#isIsfinal <em>Isfinal</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.AnnotationModificationElementImpl#isIsReplaceable <em>Is Replaceable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationModificationElementImpl extends short_class_definitionImpl implements AnnotationModificationElement
{
  /**
   ...
   * @generated
   */
  protected AnnotationModificationElementImpl()
  {
    super();
  }
  ...
  {
    return MOlocPackage.Literals.ANNOTATION_MODIFICATION_ELEMENT;
  }
  ...
  public void setRelationshipType(RelationshipType newRelationshipType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__RELATIONSHIP_TYPE, oldRelationshipType, relationshipType));
  }
  ...
  public void setParameterType(ParameterType newParameterType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__PARAMETER_TYPE, oldParameterType, parameterType));
  }
  ...
  public void setDirectionType(Direction newDirectionType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DIRECTION_TYPE, oldDirectionType, directionType));
  }
  ...
  public void setExpression(String newExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__EXPRESSION, oldExpression, expression));
  }
  ...
  public void setDeclarationName(String newDeclarationName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DECLARATION_NAME, oldDeclarationName, declarationName));
  }
  ...
  public void setElementName(String newElementName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__ELEMENT_NAME, oldElementName, elementName));
  }
  ...
  public void setIsConstrainedby(boolean newIsConstrainedby)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_CONSTRAINEDBY, oldIsConstrainedby, isConstrainedby));
  }
  ...
  public NotificationChain basicSetConstrain(ConstrainingClause newConstrain, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN, oldConstrain, newConstrain);
  ...
  public void setConstrain(ConstrainingClause newConstrain)
  {
    if (newConstrain != constrain)
    {
      ...
      if (constrain != null)
        msgs = ((InternalEObject)constrain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN, null, msgs);
      if (newConstrain != null)
        msgs = ((InternalEObject)newConstrain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN, null, msgs);
      msgs = basicSetConstrain(newConstrain, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN, newConstrain, newConstrain));
  }
  ...
  public void setIsRedeclare(boolean newIsRedeclare)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_REDECLARE, oldIsRedeclare, isRedeclare));
  }
  ...
  public void setIsEach(boolean newIsEach)
  {
    ...
    isEach = newIsEach;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_EACH, oldIsEach, isEach));
  }
  ...
  public void setIsfinal(boolean newIsfinal)
  {
    ...
    isfinal = newIsfinal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__ISFINAL, oldIsfinal, isfinal));
  }
  ...
  public void setIsReplaceable(boolean newIsReplaceable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_REPLACEABLE, oldIsReplaceable, isReplaceable));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__RELATIONSHIP_TYPE:
        return getRelationshipType();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__PARAMETER_TYPE:
        return getParameterType();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DIRECTION_TYPE:
        return getDirectionType();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__EXPRESSION:
        return getExpression();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DECLARATION_NAME:
        return getDeclarationName();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__ELEMENT_NAME:
        return getElementName();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_CONSTRAINEDBY:
        return isIsConstrainedby();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN:
        return getConstrain();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_REDECLARE:
        return isIsRedeclare();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_EACH:
        return isIsEach();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__ISFINAL:
        return isIsfinal();
      case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_REPLACEABLE:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == type_prefix.class)
    {
      ...
      {
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__RELATIONSHIP_TYPE: return MOlocPackage.TYPE_PREFIX__RELATIONSHIP_TYPE;
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__PARAMETER_TYPE: return MOlocPackage.TYPE_PREFIX__PARAMETER_TYPE;
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DIRECTION_TYPE: return MOlocPackage.TYPE_PREFIX__DIRECTION_TYPE;
        default: return -1;
      }
    }
    if (baseClass == modification.class)
    {
      switch (derivedFeatureID)
      {
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__EXPRESSION: return MOlocPackage.MODIFICATION__EXPRESSION;
        default: return -1;
      }
    }
    if (baseClass == declaration.class)
    {
      switch (derivedFeatureID)
      {
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DECLARATION_NAME: return MOlocPackage.DECLARATION__DECLARATION_NAME;
        default: return -1;
      }
    }
    ...
    if (baseClass == element_modification.class)
    {
      switch (derivedFeatureID)
      {
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__ELEMENT_NAME: return MOlocPackage.ELEMENT_MODIFICATION__ELEMENT_NAME;
        default: return -1;
      }
    }
    if (baseClass == constraining.class)
    {
      switch (derivedFeatureID)
      {
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_CONSTRAINEDBY: return MOlocPackage.CONSTRAINING__IS_CONSTRAINEDBY;
        case MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN: return MOlocPackage.CONSTRAINING__CONSTRAIN;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == type_prefix.class)
    {
      ...
      {
        case MOlocPackage.TYPE_PREFIX__RELATIONSHIP_TYPE: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__RELATIONSHIP_TYPE;
        case MOlocPackage.TYPE_PREFIX__PARAMETER_TYPE: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__PARAMETER_TYPE;
        case MOlocPackage.TYPE_PREFIX__DIRECTION_TYPE: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DIRECTION_TYPE;
        default: return -1;
      }
    }
    if (baseClass == modification.class)
    {
      switch (baseFeatureID)
      {
        case MOlocPackage.MODIFICATION__EXPRESSION: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__EXPRESSION;
        default: return -1;
      }
    }
    if (baseClass == declaration.class)
    {
      switch (baseFeatureID)
      {
        case MOlocPackage.DECLARATION__DECLARATION_NAME: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__DECLARATION_NAME;
        default: return -1;
      }
    }
    if (baseClass == component_declaration1.class)
    ...
    if (baseClass == element_modification.class)
    {
      switch (baseFeatureID)
      {
        case MOlocPackage.ELEMENT_MODIFICATION__ELEMENT_NAME: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__ELEMENT_NAME;
        default: return -1;
      }
    }
    if (baseClass == constraining.class)
    {
      switch (baseFeatureID)
      {
        case MOlocPackage.CONSTRAINING__IS_CONSTRAINEDBY: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__IS_CONSTRAINEDBY;
        case MOlocPackage.CONSTRAINING__CONSTRAIN: return MOlocPackage.ANNOTATION_MODIFICATION_ELEMENT__CONSTRAIN;
        default: return -1;
      }
    }
...
} //AnnotationModificationElementImpl
