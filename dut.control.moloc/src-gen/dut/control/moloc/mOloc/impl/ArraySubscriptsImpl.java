 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.moloc.mOloc.impl.ArraySubscriptsImpl#getSubscripts <em>Subscripts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArraySubscriptsImpl extends MinimalEObjectImpl.Container implements ArraySubscripts
{
  ...
  public EList<Subscript> getSubscripts()
  {
    if (subscripts == null)
    {
      subscripts = new EObjectContainmentEList<Subscript>(Subscript.class, this, MOlocPackage.ARRAY_SUBSCRIPTS__SUBSCRIPTS);
    }
    return subscripts;
  }
