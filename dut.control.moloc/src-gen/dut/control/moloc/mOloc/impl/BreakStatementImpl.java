 ...
 *   <li>{@link dut.control.moloc.mOloc.impl.BreakStatementImpl#getArguments <em>Arguments</em>}</li>
...
public class BreakStatementImpl extends StatementImpl implements BreakStatement
{
  ...
  {
    return MOlocPackage.Literals.BREAK_STATEMENT;
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.BREAK_STATEMENT__DESCRIPTION, oldDescription, description));
  }
  ...
  public EList<Argument> getArguments()
  {
    if (arguments == null)
    {
      arguments = new EObjectContainmentEList<Argument>(Argument.class, this, MOlocPackage.BREAK_STATEMENT__ARGUMENTS);
    }
    return arguments;
  }
  ...
  public void setIsAnnotation(boolean newIsAnnotation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.BREAK_STATEMENT__IS_ANNOTATION, oldIsAnnotation, isAnnotation));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MOlocPackage.BREAK_STATEMENT__ARGUMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MOlocPackage.BREAK_STATEMENT__DESCRIPTION:
        return getDescription();
      case MOlocPackage.BREAK_STATEMENT__ARGUMENTS:
        return getArguments();
      case MOlocPackage.BREAK_STATEMENT__IS_ANNOTATION:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == description_string.class)
    {
      ...
      {
        case MOlocPackage.BREAK_STATEMENT__DESCRIPTION: return MOlocPackage.DESCRIPTION_STRING__DESCRIPTION;
        default: return -1;
      }
    }
    if (baseClass == class_modification.class)
    {
      switch (derivedFeatureID)
      {
        case MOlocPackage.BREAK_STATEMENT__ARGUMENTS: return MOlocPackage.CLASS_MODIFICATION__ARGUMENTS;
        default: return -1;
      }
    }
    if (baseClass == description.class)
    {
      switch (derivedFeatureID)
      {
        case MOlocPackage.BREAK_STATEMENT__IS_ANNOTATION: return MOlocPackage.DESCRIPTION__IS_ANNOTATION;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == description_string.class)
    {
      ...
      {
        case MOlocPackage.DESCRIPTION_STRING__DESCRIPTION: return MOlocPackage.BREAK_STATEMENT__DESCRIPTION;
        default: return -1;
      }
    }
    if (baseClass == class_modification.class)
    {
      switch (baseFeatureID)
      {
        case MOlocPackage.CLASS_MODIFICATION__ARGUMENTS: return MOlocPackage.BREAK_STATEMENT__ARGUMENTS;
        default: return -1;
      }
    }
    if (baseClass == description.class)
    {
      switch (baseFeatureID)
      {
        case MOlocPackage.DESCRIPTION__IS_ANNOTATION: return MOlocPackage.BREAK_STATEMENT__IS_ANNOTATION;
        default: return -1;
      }
    }
