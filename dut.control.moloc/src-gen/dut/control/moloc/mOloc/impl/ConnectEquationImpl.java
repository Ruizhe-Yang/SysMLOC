...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Connect Equation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ConnectEquationImpl extends EquationImpl implements ConnectEquation
{
  /**
  ...
  {
    return MOlocPackage.Literals.CONNECT_EQUATION;
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.CONNECT_EQUATION__DESCRIPTION, oldDescription, description));
  }
  ...
  public void setLeft(String newLeft)
  {
    ...
    left = newLeft;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.CONNECT_EQUATION__LEFT, oldLeft, left));
  }
  ...
  public void setRight(String newRight)
  {
    ...
    right = newRight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.CONNECT_EQUATION__RIGHT, oldRight, right));
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == description_string.class)
    {
      ...
      {
        case MOlocPackage.CONNECT_EQUATION__DESCRIPTION: return MOlocPackage.DESCRIPTION_STRING__DESCRIPTION;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == description_string.class)
    {
      ...
      {
        case MOlocPackage.DESCRIPTION_STRING__DESCRIPTION: return MOlocPackage.CONNECT_EQUATION__DESCRIPTION;
        default: return -1;
      }
    }
    if (baseClass == class_modification.class)
