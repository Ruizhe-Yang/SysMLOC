 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.moloc.mOloc.impl.EnumListImpl#getEnums <em>Enums</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumListImpl extends MinimalEObjectImpl.Container implements EnumList
{
  ...
  public EList<EnumerationLiteral> getEnums()
  {
    if (enums == null)
    {
      enums = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, MOlocPackage.ENUM_LIST__ENUMS);
    }
    return enums;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MOlocPackage.ENUM_LIST__ENUMS:
