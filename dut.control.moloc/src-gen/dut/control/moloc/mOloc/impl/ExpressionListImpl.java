 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.moloc.mOloc.impl.ExpressionListImpl#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionListImpl extends MinimalEObjectImpl.Container implements ExpressionList
{
  ...
  {
    return MOlocPackage.Literals.EXPRESSION_LIST;
  }
  ...
  public EList<Expression> getExprs()
  {
    if (exprs == null)
    {
      exprs = new EObjectContainmentEList<Expression>(Expression.class, this, MOlocPackage.EXPRESSION_LIST__EXPRS);
    }
    return exprs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MOlocPackage.EXPRESSION_LIST__EXPRS:
