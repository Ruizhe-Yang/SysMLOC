 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.moloc.mOloc.impl.IfEquationImpl#getIf_expr <em>If expr</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.IfEquationImpl#getIf_eqs <em>If eqs</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.IfEquationImpl#getElsif_exprs <em>Elsif exprs</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.IfEquationImpl#getElseif_eqs <em>Elseif eqs</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.IfEquationImpl#getElse_eqs <em>Else eqs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfEquationImpl extends EquationImpl implements IfEquation
{
  ...
  public NotificationChain basicSetIf_expr(Expression newIf_expr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MOlocPackage.IF_EQUATION__IF_EXPR, oldIf_expr, newIf_expr);
  ...
  public void setIf_expr(Expression newIf_expr)
  {
    if (newIf_expr != if_expr)
    {
      ...
      if (if_expr != null)
        msgs = ((InternalEObject)if_expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MOlocPackage.IF_EQUATION__IF_EXPR, null, msgs);
      if (newIf_expr != null)
        msgs = ((InternalEObject)newIf_expr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MOlocPackage.IF_EQUATION__IF_EXPR, null, msgs);
      msgs = basicSetIf_expr(newIf_expr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.IF_EQUATION__IF_EXPR, newIf_expr, newIf_expr));
  }
  ...
  public EList<Equation> getIf_eqs()
  {
    if (if_eqs == null)
    {
      if_eqs = new EObjectContainmentEList<Equation>(Equation.class, this, MOlocPackage.IF_EQUATION__IF_EQS);
    }
    return if_eqs;
  }
  ...
  public EList<Expression> getElsif_exprs()
  {
    if (elsif_exprs == null)
    {
      elsif_exprs = new EObjectContainmentEList<Expression>(Expression.class, this, MOlocPackage.IF_EQUATION__ELSIF_EXPRS);
    }
    return elsif_exprs;
  }
  ...
  public EList<Equation> getElseif_eqs()
  {
    if (elseif_eqs == null)
    {
      elseif_eqs = new EObjectContainmentEList<Equation>(Equation.class, this, MOlocPackage.IF_EQUATION__ELSEIF_EQS);
    }
    return elseif_eqs;
  }
  ...
  public EList<Equation> getElse_eqs()
  {
    if (else_eqs == null)
    {
      else_eqs = new EObjectContainmentEList<Equation>(Equation.class, this, MOlocPackage.IF_EQUATION__ELSE_EQS);
    }
    return else_eqs;
  }
