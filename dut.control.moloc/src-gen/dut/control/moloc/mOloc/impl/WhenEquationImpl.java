 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.moloc.mOloc.impl.WhenEquationImpl#getWhen <em>When</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.WhenEquationImpl#getWhen_eqs <em>When eqs</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.WhenEquationImpl#getElsehwhen <em>Elsehwhen</em>}</li>
 *   <li>{@link dut.control.moloc.mOloc.impl.WhenEquationImpl#getElsewhen_eqs <em>Elsewhen eqs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WhenEquationImpl extends EquationImpl implements WhenEquation
{
  ...
  public NotificationChain basicSetWhen(Expression newWhen, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MOlocPackage.WHEN_EQUATION__WHEN, oldWhen, newWhen);
  ...
  public void setWhen(Expression newWhen)
  {
    if (newWhen != when)
    {
      ...
      if (when != null)
        msgs = ((InternalEObject)when).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MOlocPackage.WHEN_EQUATION__WHEN, null, msgs);
      if (newWhen != null)
        msgs = ((InternalEObject)newWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MOlocPackage.WHEN_EQUATION__WHEN, null, msgs);
      msgs = basicSetWhen(newWhen, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MOlocPackage.WHEN_EQUATION__WHEN, newWhen, newWhen));
  }
  ...
  public EList<Equation> getWhen_eqs()
  {
    if (when_eqs == null)
    {
      when_eqs = new EObjectContainmentEList<Equation>(Equation.class, this, MOlocPackage.WHEN_EQUATION__WHEN_EQS);
    }
    return when_eqs;
  }
  ...
  public EList<Expression> getElsehwhen()
  {
    if (elsehwhen == null)
    {
      elsehwhen = new EObjectContainmentEList<Expression>(Expression.class, this, MOlocPackage.WHEN_EQUATION__ELSEHWHEN);
    }
    return elsehwhen;
  }
  ...
  public EList<Equation> getElsewhen_eqs()
  {
    ...
    {
      elsewhen_eqs = new EObjectContainmentEList<Equation>(Equation.class, this, MOlocPackage.WHEN_EQUATION__ELSEWHEN_EQS);
    }
    return elsewhen_eqs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MOlocPackage.WHEN_EQUATION__WHEN:
        return basicSetWhen(null, msgs);
      case MOlocPackage.WHEN_EQUATION__WHEN_EQS:
        return ((InternalEList<?>)getWhen_eqs()).basicRemove(otherEnd, msgs);
      case MOlocPackage.WHEN_EQUATION__ELSEHWHEN:
        return ((InternalEList<?>)getElsehwhen()).basicRemove(otherEnd, msgs);
      case MOlocPackage.WHEN_EQUATION__ELSEWHEN_EQS:
