...
@after {
	...
	(
		...
		(
			...
			{
				$current = $this_element_modification_4.current;
				afterParserOrEnumRuleCall();
			}
		)
	)
...
@after {
	...
	(
		...
		{
			$current = $this_type_prefix_7.current;
			afterParserOrEnumRuleCall();
		}
		{
			/* */
		...
		{
			$current = $this_type_specifier_8.current;
			afterParserOrEnumRuleCall();
		}
		(
			{
			...
			{
				$current = $this_array_subscripts_9.current;
				afterParserOrEnumRuleCall();
			}
		)?
		(
