...
@after {
	...
	(
		...
		{
			$current = $this_type_specifier_0.current;
			afterParserOrEnumRuleCall();
		}
		(
			{
...
@after {
	...
	(
		...
		{
			$current = $this_ComponentClause_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
	...
	(
		...
		(
			...
			(
				(
					(
						lv_isAnnotation1_17_0='annotation'
						{
...
@after {
	...
	(
		(
			(
				lv_isConstrainedby_0_0='constrainedby'
				{
