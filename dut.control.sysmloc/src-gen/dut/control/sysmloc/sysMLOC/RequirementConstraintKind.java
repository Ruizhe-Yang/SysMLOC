 ...
 * <!-- end-user-doc -->
 * @see dut.control.sysmloc.sysMLOC.SysMLOCPackage#getRequirementConstraintKind()
 * @model
 * @generated
 */
public enum RequirementConstraintKind implements Enumerator
{
   ...
   * @ordered
   */
  ASSUMPTION(0, "assumption", "assume"),
   ...
   * @ordered
   */
  REQUIREMENT(1, "requirement", "require");
   ...
   * <!-- end-user-doc -->
   * @see #ASSUMPTION
   * @model name="assumption" literal="assume"
   * @generated
   * @ordered
   */
   ...
   * <!-- end-user-doc -->
   * @see #REQUIREMENT
   * @model name="requirement" literal="require"
   * @generated
   * @ordered
   */
