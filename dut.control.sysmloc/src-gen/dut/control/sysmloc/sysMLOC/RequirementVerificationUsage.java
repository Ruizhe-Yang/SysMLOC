...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Requirement Verification Usage</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.RequirementVerificationUsage#getElements <em>Elements</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.RequirementVerificationUsage#getResultExpressionParameter <em>Result Expression Parameter</em>}</li>
 * </ul>
 *
 * @see dut.control.sysmloc.sysMLOC.SysMLOCPackage#getRequirementVerificationUsage()
 * @model
 * @generated
 */
public interface RequirementVerificationUsage extends RequirementNodeElements, MemberPrefix, ReferenceSubsetting, FeatureSpecialization, TypingFeatureTyping, SubsettingFeatureChain, ReferenceFeatureChain, CrossFeatureChain, RedefinitionFeatureChain, UsageExtensionKeyword, PrefixMetadata, ConstraintUsageDeclaration, UsageDeclaration, FeatureDeclaration, Identification, FeatureSpecializationPart, MultiplicityPart, MultiplicityRange, ValuePart, FeatureValue
{
   ...
   * @see dut.control.sysmloc.sysMLOC.SysMLOCPackage#getRequirementVerificationUsage_Elements()
   ...
   * @see dut.control.sysmloc.sysMLOC.SysMLOCPackage#getRequirementVerificationUsage_ResultExpressionParameter()
   * @model containment="true"
   * @generated
   */
