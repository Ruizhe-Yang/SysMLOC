 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.AssignmentNodeImpl#getMultiplicity <em>Multiplicity</em>}</li>
...
public class AssignmentNodeImpl extends ActionNodeElementsImpl implements AssignmentNode
{
  ...
  public EList<String> getMultiplicity()
  {
    ...
    {
      multiplicity = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ASSIGNMENT_NODE__MULTIPLICITY);
    }
    return multiplicity;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.ASSIGNMENT_NODE__MULTIPLICITY:
