 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.AttributeUsageImpl#getCrossEndUsage <em>Cross End Usage</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.AttributeUsageImpl#isIsDefault <em>Is Default</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.AttributeUsageImpl#getValuePart <em>Value Part</em>}</li>
...
public class AttributeUsageImpl extends NonOccurrenceUsageElementImpl implements AttributeUsage
{
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public NotificationChain basicSetCrossEndUsage(CrossEndUsage newCrossEndUsage, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE, oldCrossEndUsage, newCrossEndUsage);
  ...
  public void setCrossEndUsage(CrossEndUsage newCrossEndUsage)
  {
    if (newCrossEndUsage != crossEndUsage)
    {
      ...
      if (crossEndUsage != null)
        msgs = ((InternalEObject)crossEndUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE, null, msgs);
      if (newCrossEndUsage != null)
        msgs = ((InternalEObject)newCrossEndUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE, null, msgs);
      msgs = basicSetCrossEndUsage(newCrossEndUsage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE, newCrossEndUsage, newCrossEndUsage));
  }
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ATTRIBUTE_USAGE__PREFIX_METADATA_EXTENSION);
    }
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public EList<String> getTypings()
  {
    if (typings == null)
    {
      typings = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ATTRIBUTE_USAGE__TYPINGS);
    }
    return typings;
  }
  ...
  public EList<String> getSubsetting()
  {
    if (subsetting == null)
    {
      subsetting = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ATTRIBUTE_USAGE__SUBSETTING);
    }
    return subsetting;
  }
  ...
  public EList<String> getReferences()
  {
    if (references == null)
    {
      references = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ATTRIBUTE_USAGE__REFERENCES);
    }
    return references;
  }
  ...
  public EList<String> getCrosses()
  {
    if (crosses == null)
    {
      crosses = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ATTRIBUTE_USAGE__CROSSES);
    }
    return crosses;
  }
  ...
  public EList<String> getRedefinitions()
  {
    ...
    {
      redefinitions = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ATTRIBUTE_USAGE__REDEFINITIONS);
    }
  ...
  public void setIsOrdered(boolean newIsOrdered)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__IS_ORDERED, oldIsOrdered, isOrdered));
  }
  ...
  public void setIsNonunique(boolean newIsNonunique)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__IS_NONUNIQUE, oldIsNonunique, isNonunique));
  }
  ...
  public void setIsInitial(boolean newIsInitial)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__IS_INITIAL, oldIsInitial, isInitial));
  }
  ...
  public void setIsDefault(boolean newIsDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__IS_DEFAULT, oldIsDefault, isDefault));
  }
  ...
  public void setValuePart(String newValuePart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ATTRIBUTE_USAGE__VALUE_PART, oldValuePart, valuePart));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.ATTRIBUTE_USAGE__IS_VARIANT:
        return isIsVariant();
      ...
      case SysMLOCPackage.ATTRIBUTE_USAGE__DECLARED_SHORT_NAME:
      ...
      case SysMLOCPackage.ATTRIBUTE_USAGE__REFERENCES:
        return getReferences();
      case SysMLOCPackage.ATTRIBUTE_USAGE__CROSSES:
        return getCrosses();
      ...
      case SysMLOCPackage.ATTRIBUTE_USAGE__IS_INITIAL:
        return isIsInitial();
      case SysMLOCPackage.ATTRIBUTE_USAGE__IS_DEFAULT:
        return isIsDefault();
      case SysMLOCPackage.ATTRIBUTE_USAGE__VALUE_PART:
        return getValuePart();
      case SysMLOCPackage.ATTRIBUTE_USAGE__ELEMENTS:
        return getElements();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      switch (derivedFeatureID)
      {
        ...
        case SysMLOCPackage.ATTRIBUTE_USAGE__IS_VARIANT: return SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT;
        default: return -1;
      }
    }
    ...
    if (baseClass == CrossEndUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE: return SysMLOCPackage.CROSS_END_USAGE_PREFIX__CROSS_END_USAGE;
        default: return -1;
      }
    }
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.ATTRIBUTE_USAGE__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    ...
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == Identification.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__DECLARED_SHORT_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.ATTRIBUTE_USAGE__DECLARED_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__SUBSETTING: return SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__REFERENCES: return SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__CROSSES: return SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__REDEFINITIONS: return SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS;
        default: return -1;
      }
    }
    ...
    if (baseClass == FeatureValue.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ATTRIBUTE_USAGE__IS_INITIAL: return SysMLOCPackage.FEATURE_VALUE__IS_INITIAL;
        case SysMLOCPackage.ATTRIBUTE_USAGE__IS_DEFAULT: return SysMLOCPackage.FEATURE_VALUE__IS_DEFAULT;
        case SysMLOCPackage.ATTRIBUTE_USAGE__VALUE_PART: return SysMLOCPackage.FEATURE_VALUE__VALUE_PART;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      switch (baseFeatureID)
      {
        ...
        case SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT: return SysMLOCPackage.ATTRIBUTE_USAGE__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == isReturnPrefix.class)
    ...
    if (baseClass == CrossEndUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_END_USAGE_PREFIX__CROSS_END_USAGE: return SysMLOCPackage.ATTRIBUTE_USAGE__CROSS_END_USAGE;
        default: return -1;
      }
    }
    if (baseClass == EndUsagePrefix.class)
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.ATTRIBUTE_USAGE__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.ATTRIBUTE_USAGE__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    ...
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.ATTRIBUTE_USAGE__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == UsageExtensionKeyword.class)
    ...
    if (baseClass == Identification.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME: return SysMLOCPackage.ATTRIBUTE_USAGE__DECLARED_SHORT_NAME;
        case SysMLOCPackage.IDENTIFICATION__DECLARED_NAME: return SysMLOCPackage.ATTRIBUTE_USAGE__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS: return SysMLOCPackage.ATTRIBUTE_USAGE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING: return SysMLOCPackage.ATTRIBUTE_USAGE__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES: return SysMLOCPackage.ATTRIBUTE_USAGE__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES: return SysMLOCPackage.ATTRIBUTE_USAGE__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS: return SysMLOCPackage.ATTRIBUTE_USAGE__REDEFINITIONS;
        default: return -1;
      }
    }
    if (baseClass == FeatureSpecialization.class)
    ...
    if (baseClass == FeatureValue.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.FEATURE_VALUE__IS_INITIAL: return SysMLOCPackage.ATTRIBUTE_USAGE__IS_INITIAL;
        case SysMLOCPackage.FEATURE_VALUE__IS_DEFAULT: return SysMLOCPackage.ATTRIBUTE_USAGE__IS_DEFAULT;
        case SysMLOCPackage.FEATURE_VALUE__VALUE_PART: return SysMLOCPackage.ATTRIBUTE_USAGE__VALUE_PART;
        default: return -1;
      }
    }
    if (baseClass == Usage.class)
