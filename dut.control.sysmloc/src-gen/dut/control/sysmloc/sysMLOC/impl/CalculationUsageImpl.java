 ...
 * @generated
 */
public class CalculationUsageImpl extends BehaviorUsageElementImpl implements CalculationUsage
{
  /**
  ...
  public EList<String> getValuePart()
  {
    if (valuePart == null)
    {
      valuePart = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.CALCULATION_USAGE__VALUE_PART);
    }
    return valuePart;
  }
