 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.CommonNodeImpl#isIsConstant <em>Is Constant</em>}</li>
...
public class CommonNodeImpl extends ActionNodeElementsImpl implements CommonNode
{
  ...
  public void setThenMultiLow(String newThenMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.COMMON_NODE__THEN_MULTI_LOW, oldThenMultiLow, thenMultiLow));
  }
  ...
  public void setThenMultiHigh(String newThenMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.COMMON_NODE__THEN_MULTI_HIGH, oldThenMultiHigh, thenMultiHigh));
  }
  ...
  public void setIsConstant(boolean newIsConstant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.COMMON_NODE__IS_CONSTANT, oldIsConstant, isConstant));
  }
  ...
  public void setMultiLow(String newMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.COMMON_NODE__MULTI_LOW, oldMultiLow, multiLow));
  }
  ...
  public void setMultiHigh(String newMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.COMMON_NODE__MULTI_HIGH, oldMultiHigh, multiHigh));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.COMMON_NODE__IS_DERIVED:
        return isIsDerived();
      case SysMLOCPackage.COMMON_NODE__IS_CONSTANT:
        return isIsConstant();
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == RefPrefix.class)
    {
      switch (derivedFeatureID)
      {
        ...
        case SysMLOCPackage.COMMON_NODE__IS_CONSTANT: return SysMLOCPackage.REF_PREFIX__IS_CONSTANT;
        default: return -1;
      }
    }
    ...
    if (baseClass == TypingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.COMMON_NODE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_CHAIN__TYPINGS;
        default: return -1;
      }
    }
    ...
    if (baseClass == MultiplicityModifiers.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.COMMON_NODE__IS_ORDERED: return SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_ORDERED;
        case SysMLOCPackage.COMMON_NODE__IS_NONUNIQUE: return SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_NONUNIQUE;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == RefPrefix.class)
    {
      switch (baseFeatureID)
      {
        ...
        case SysMLOCPackage.REF_PREFIX__IS_CONSTANT: return SysMLOCPackage.COMMON_NODE__IS_CONSTANT;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    ...
    if (baseClass == TypingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_CHAIN__TYPINGS: return SysMLOCPackage.COMMON_NODE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    ...
    if (baseClass == MultiplicityModifiers.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_ORDERED: return SysMLOCPackage.COMMON_NODE__IS_ORDERED;
        case SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_NONUNIQUE: return SysMLOCPackage.COMMON_NODE__IS_NONUNIQUE;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityPart.class)
