...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Do Action Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class DoActionNodeImpl extends StateBodyElementImpl implements DoActionNode
{
  ...
  {
    return SysMLOCPackage.eINSTANCE.getDoActionNode();
  }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.DO_ACTION_NODE__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public EList<PerformedActionUsage> getPerformedActionParameterPart()
  {
    ...
    {
      performedActionParameterPart = new EObjectContainmentEList<PerformedActionUsage>(PerformedActionUsage.class, this, SysMLOCPackage.DO_ACTION_NODE__PERFORMED_ACTION_PARAMETER_PART);
    }
  ...
  public EList<ActionBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<ActionBodyElement>(ActionBodyElement.class, this, SysMLOCPackage.DO_ACTION_NODE__ELEMENTS);
    }
    return elements;
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == PerformedActionParameterPart.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.DO_ACTION_NODE__PERFORMED_ACTION_PARAMETER_PART: return SysMLOCPackage.PERFORMED_ACTION_PARAMETER_PART__PERFORMED_ACTION_PARAMETER_PART;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == PerformedActionParameterPart.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PERFORMED_ACTION_PARAMETER_PART__PERFORMED_ACTION_PARAMETER_PART: return SysMLOCPackage.DO_ACTION_NODE__PERFORMED_ACTION_PARAMETER_PART;
        default: return -1;
      }
    }
