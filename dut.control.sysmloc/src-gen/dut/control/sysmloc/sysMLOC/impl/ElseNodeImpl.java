...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Else Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsThen <em>Is Then</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getThenMultiValue <em>Then Multi Value</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getThenMultiLow <em>Then Multi Low</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getEndMultiValue <em>End Multi Value</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getEndMultiLow <em>End Multi Low</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getEndMultiHigh <em>End Multi High</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsConstant <em>Is Constant</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsReference <em>Is Reference</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getPrefixMetadataExtension <em>Prefix Metadata Extension</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsIndividual <em>Is Individual</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getPortionKind <em>Portion Kind</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getDeclaredShortName <em>Declared Short Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getDeclaredName <em>Declared Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getTypings <em>Typings</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getSubsetting <em>Subsetting</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getReferences <em>References</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getCrosses <em>Crosses</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getRedefinitions <em>Redefinitions</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getMultiValue <em>Multi Value</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getMultiLow <em>Multi Low</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getMultiHigh <em>Multi High</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#isIsNonunique <em>Is Nonunique</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getActionParameterEnd <em>Action Parameter End</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getElseEnd <em>Else End</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.ElseNodeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElseNodeImpl extends ActionNodeElementsImpl implements ElseNode
{
  /**
  ...
  /**
   * The cached value of the '{@link #getElseEnd() <em>Else End</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getElseEnd()
   * @generated
   * @ordered
   */
  protected EList<ConnectorEnd> elseEnd;
  ...
  {
    return SysMLOCPackage.eINSTANCE.getElseNode();
  }
  ...
  public void setIsThen(boolean newIsThen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_THEN, oldIsThen, isThen));
  }
  ...
  public void setThenMultiValue(String newThenMultiValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__THEN_MULTI_VALUE, oldThenMultiValue, thenMultiValue));
  }
  ...
  public void setThenMultiLow(String newThenMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__THEN_MULTI_LOW, oldThenMultiLow, thenMultiLow));
  }
  ...
  public void setThenMultiHigh(String newThenMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__THEN_MULTI_HIGH, oldThenMultiHigh, thenMultiHigh));
  }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public void setEndMultiValue(String newEndMultiValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__END_MULTI_VALUE, oldEndMultiValue, endMultiValue));
  }
  ...
  public void setEndMultiLow(String newEndMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__END_MULTI_LOW, oldEndMultiLow, endMultiLow));
  }
  ...
  public void setEndMultiHigh(String newEndMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__END_MULTI_HIGH, oldEndMultiHigh, endMultiHigh));
  }
  ...
  public void setIsEnd(boolean newIsEnd)
  {
    ...
    isEnd = newIsEnd;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_END, oldIsEnd, isEnd));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public void setDirection(FeatureDirection newDirection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__DIRECTION, oldDirection, direction));
  }
  ...
  public void setIsDerived(boolean newIsDerived)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_DERIVED, oldIsDerived, isDerived));
  }
  ...
  public void setIsConstant(boolean newIsConstant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_CONSTANT, oldIsConstant, isConstant));
  }
  ...
  public void setIsReference(boolean newIsReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_REFERENCE, oldIsReference, isReference));
  }
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ELSE_NODE__PREFIX_METADATA_EXTENSION);
    }
  ...
  public void setIsIndividual(boolean newIsIndividual)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_INDIVIDUAL, oldIsIndividual, isIndividual));
  }
  ...
  public void setPortionKind(PortionKind newPortionKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__PORTION_KIND, oldPortionKind, portionKind));
  }
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<String> getTypings()
  {
    if (typings == null)
    {
      typings = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ELSE_NODE__TYPINGS);
    }
    return typings;
  }
  ...
  public EList<String> getSubsetting()
  {
    if (subsetting == null)
    {
      subsetting = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ELSE_NODE__SUBSETTING);
    }
    return subsetting;
  }
  ...
  public EList<String> getReferences()
  {
    if (references == null)
    {
      references = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ELSE_NODE__REFERENCES);
    }
    return references;
  }
  ...
  public EList<String> getCrosses()
  {
    if (crosses == null)
    {
      crosses = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ELSE_NODE__CROSSES);
    }
    return crosses;
  }
  ...
  public EList<String> getRedefinitions()
  {
    ...
    {
      redefinitions = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ELSE_NODE__REDEFINITIONS);
    }
  ...
  public void setMultiValue(String newMultiValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__MULTI_VALUE, oldMultiValue, multiValue));
  }
  ...
  public void setMultiLow(String newMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__MULTI_LOW, oldMultiLow, multiLow));
  }
  ...
  public void setMultiHigh(String newMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__MULTI_HIGH, oldMultiHigh, multiHigh));
  }
  ...
  public void setIsOrdered(boolean newIsOrdered)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_ORDERED, oldIsOrdered, isOrdered));
  }
  ...
  public void setIsNonunique(boolean newIsNonunique)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ELSE_NODE__IS_NONUNIQUE, oldIsNonunique, isNonunique));
  }
  ...
  public EList<ActionParameterEnd> getActionParameterEnd()
  {
    ...
    {
      actionParameterEnd = new EObjectContainmentEList<ActionParameterEnd>(ActionParameterEnd.class, this, SysMLOCPackage.ELSE_NODE__ACTION_PARAMETER_END);
    }
   ...
   */
  @Override
  public EList<ConnectorEnd> getElseEnd()
  {
    if (elseEnd == null)
    {
      elseEnd = new EObjectContainmentEList<ConnectorEnd>(ConnectorEnd.class, this, SysMLOCPackage.ELSE_NODE__ELSE_END);
    }
    return elseEnd;
  }
  ...
  public EList<ActionBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<ActionBodyElement>(ActionBodyElement.class, this, SysMLOCPackage.ELSE_NODE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.ELSE_NODE__ELSE_END:
        return ((InternalEList<?>)getElseEnd()).basicRemove(otherEnd, msgs);
      case SysMLOCPackage.ELSE_NODE__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SysMLOCPackage.ELSE_NODE__IS_THEN:
        return isIsThen();
      case SysMLOCPackage.ELSE_NODE__THEN_MULTI_VALUE:
        return getThenMultiValue();
      case SysMLOCPackage.ELSE_NODE__THEN_MULTI_LOW:
        return getThenMultiLow();
      case SysMLOCPackage.ELSE_NODE__THEN_MULTI_HIGH:
        return getThenMultiHigh();
      case SysMLOCPackage.ELSE_NODE__VISIBILITY:
        return getVisibility();
      case SysMLOCPackage.ELSE_NODE__IS_VARIANT:
        return isIsVariant();
      case SysMLOCPackage.ELSE_NODE__END_MULTI_VALUE:
        return getEndMultiValue();
      case SysMLOCPackage.ELSE_NODE__END_MULTI_LOW:
        return getEndMultiLow();
      case SysMLOCPackage.ELSE_NODE__END_MULTI_HIGH:
        return getEndMultiHigh();
      case SysMLOCPackage.ELSE_NODE__IS_END:
        return isIsEnd();
      case SysMLOCPackage.ELSE_NODE__IS_ABSTRACT:
        return isIsAbstract();
      case SysMLOCPackage.ELSE_NODE__IS_VARIATION:
        return isIsVariation();
      case SysMLOCPackage.ELSE_NODE__DIRECTION:
        return getDirection();
      case SysMLOCPackage.ELSE_NODE__IS_DERIVED:
        return isIsDerived();
      case SysMLOCPackage.ELSE_NODE__IS_CONSTANT:
        return isIsConstant();
      case SysMLOCPackage.ELSE_NODE__IS_REFERENCE:
        return isIsReference();
      case SysMLOCPackage.ELSE_NODE__PREFIX_METADATA_EXTENSION:
        return getPrefixMetadataExtension();
      case SysMLOCPackage.ELSE_NODE__IS_INDIVIDUAL:
        return isIsIndividual();
      case SysMLOCPackage.ELSE_NODE__PORTION_KIND:
        return getPortionKind();
      case SysMLOCPackage.ELSE_NODE__DECLARED_SHORT_NAME:
        return getDeclaredShortName();
      case SysMLOCPackage.ELSE_NODE__DECLARED_NAME:
        return getDeclaredName();
      case SysMLOCPackage.ELSE_NODE__TYPINGS:
        return getTypings();
      case SysMLOCPackage.ELSE_NODE__SUBSETTING:
        return getSubsetting();
      case SysMLOCPackage.ELSE_NODE__REFERENCES:
        return getReferences();
      case SysMLOCPackage.ELSE_NODE__CROSSES:
        return getCrosses();
      case SysMLOCPackage.ELSE_NODE__REDEFINITIONS:
        return getRedefinitions();
      case SysMLOCPackage.ELSE_NODE__MULTI_VALUE:
        return getMultiValue();
      case SysMLOCPackage.ELSE_NODE__MULTI_LOW:
        return getMultiLow();
      case SysMLOCPackage.ELSE_NODE__MULTI_HIGH:
        return getMultiHigh();
      case SysMLOCPackage.ELSE_NODE__IS_ORDERED:
        return isIsOrdered();
      case SysMLOCPackage.ELSE_NODE__IS_NONUNIQUE:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.ELSE_NODE__ELSE_END:
        getElseEnd().clear();
        getElseEnd().addAll((Collection<? extends ConnectorEnd>)newValue);
        return;
      case SysMLOCPackage.ELSE_NODE__ELEMENTS:
        getElements().clear();
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.ELSE_NODE__ELSE_END:
        return elseEnd != null && !elseEnd.isEmpty();
      case SysMLOCPackage.ELSE_NODE__ELEMENTS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == EmptySuccessionPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.ELSE_NODE__IS_THEN: return SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__IS_THEN;
        case SysMLOCPackage.ELSE_NODE__THEN_MULTI_VALUE: return SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTI_VALUE;
        case SysMLOCPackage.ELSE_NODE__THEN_MULTI_LOW: return SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTI_LOW;
        case SysMLOCPackage.ELSE_NODE__THEN_MULTI_HIGH: return SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTI_HIGH;
        default: return -1;
      }
    }
    ...
    if (baseClass == EndMultiplicityRange.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__END_MULTI_VALUE: return SysMLOCPackage.END_MULTIPLICITY_RANGE__END_MULTI_VALUE;
        case SysMLOCPackage.ELSE_NODE__END_MULTI_LOW: return SysMLOCPackage.END_MULTIPLICITY_RANGE__END_MULTI_LOW;
        case SysMLOCPackage.ELSE_NODE__END_MULTI_HIGH: return SysMLOCPackage.END_MULTIPLICITY_RANGE__END_MULTI_HIGH;
        default: return -1;
      }
    }
    if (baseClass == EndUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__IS_END: return SysMLOCPackage.END_USAGE_PREFIX__IS_END;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.ELSE_NODE__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__DIRECTION: return SysMLOCPackage.REF_PREFIX__DIRECTION;
        case SysMLOCPackage.ELSE_NODE__IS_DERIVED: return SysMLOCPackage.REF_PREFIX__IS_DERIVED;
        case SysMLOCPackage.ELSE_NODE__IS_CONSTANT: return SysMLOCPackage.REF_PREFIX__IS_CONSTANT;
        default: return -1;
      }
    }
    if (baseClass == BasicUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__IS_REFERENCE: return SysMLOCPackage.BASIC_USAGE_PREFIX__IS_REFERENCE;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == OccurrenceUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__IS_INDIVIDUAL: return SysMLOCPackage.OCCURRENCE_USAGE_PREFIX__IS_INDIVIDUAL;
        case SysMLOCPackage.ELSE_NODE__PORTION_KIND: return SysMLOCPackage.OCCURRENCE_USAGE_PREFIX__PORTION_KIND;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__DECLARED_SHORT_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.ELSE_NODE__DECLARED_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__SUBSETTING: return SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__REFERENCES: return SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__CROSSES: return SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__REDEFINITIONS: return SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS;
        default: return -1;
      }
    }
    ...
    if (baseClass == MultiplicityRange.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__MULTI_VALUE: return SysMLOCPackage.MULTIPLICITY_RANGE__MULTI_VALUE;
        case SysMLOCPackage.ELSE_NODE__MULTI_LOW: return SysMLOCPackage.MULTIPLICITY_RANGE__MULTI_LOW;
        case SysMLOCPackage.ELSE_NODE__MULTI_HIGH: return SysMLOCPackage.MULTIPLICITY_RANGE__MULTI_HIGH;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityModifiers.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ELSE_NODE__IS_ORDERED: return SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_ORDERED;
        case SysMLOCPackage.ELSE_NODE__IS_NONUNIQUE: return SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_NONUNIQUE;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == EmptySuccessionPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__IS_THEN: return SysMLOCPackage.ELSE_NODE__IS_THEN;
        case SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTI_VALUE: return SysMLOCPackage.ELSE_NODE__THEN_MULTI_VALUE;
        case SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTI_LOW: return SysMLOCPackage.ELSE_NODE__THEN_MULTI_LOW;
        case SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTI_HIGH: return SysMLOCPackage.ELSE_NODE__THEN_MULTI_HIGH;
        default: return -1;
      }
    }
    if (baseClass == MemberPrefix.class)
    ...
    if (baseClass == EndMultiplicityRange.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.END_MULTIPLICITY_RANGE__END_MULTI_VALUE: return SysMLOCPackage.ELSE_NODE__END_MULTI_VALUE;
        case SysMLOCPackage.END_MULTIPLICITY_RANGE__END_MULTI_LOW: return SysMLOCPackage.ELSE_NODE__END_MULTI_LOW;
        case SysMLOCPackage.END_MULTIPLICITY_RANGE__END_MULTI_HIGH: return SysMLOCPackage.ELSE_NODE__END_MULTI_HIGH;
        default: return -1;
      }
    }
    if (baseClass == EndUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.END_USAGE_PREFIX__IS_END: return SysMLOCPackage.ELSE_NODE__IS_END;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.ELSE_NODE__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.ELSE_NODE__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REF_PREFIX__DIRECTION: return SysMLOCPackage.ELSE_NODE__DIRECTION;
        case SysMLOCPackage.REF_PREFIX__IS_DERIVED: return SysMLOCPackage.ELSE_NODE__IS_DERIVED;
        case SysMLOCPackage.REF_PREFIX__IS_CONSTANT: return SysMLOCPackage.ELSE_NODE__IS_CONSTANT;
        default: return -1;
      }
    }
    if (baseClass == BasicUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_USAGE_PREFIX__IS_REFERENCE: return SysMLOCPackage.ELSE_NODE__IS_REFERENCE;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.ELSE_NODE__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == UsageExtensionKeyword.class)
    ...
    if (baseClass == OccurrenceUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_USAGE_PREFIX__IS_INDIVIDUAL: return SysMLOCPackage.ELSE_NODE__IS_INDIVIDUAL;
        case SysMLOCPackage.OCCURRENCE_USAGE_PREFIX__PORTION_KIND: return SysMLOCPackage.ELSE_NODE__PORTION_KIND;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME: return SysMLOCPackage.ELSE_NODE__DECLARED_SHORT_NAME;
        case SysMLOCPackage.IDENTIFICATION__DECLARED_NAME: return SysMLOCPackage.ELSE_NODE__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS: return SysMLOCPackage.ELSE_NODE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING: return SysMLOCPackage.ELSE_NODE__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES: return SysMLOCPackage.ELSE_NODE__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES: return SysMLOCPackage.ELSE_NODE__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS: return SysMLOCPackage.ELSE_NODE__REDEFINITIONS;
        default: return -1;
      }
    }
    if (baseClass == FeatureSpecialization.class)
    ...
    if (baseClass == MultiplicityRange.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MULTIPLICITY_RANGE__MULTI_VALUE: return SysMLOCPackage.ELSE_NODE__MULTI_VALUE;
        case SysMLOCPackage.MULTIPLICITY_RANGE__MULTI_LOW: return SysMLOCPackage.ELSE_NODE__MULTI_LOW;
        case SysMLOCPackage.MULTIPLICITY_RANGE__MULTI_HIGH: return SysMLOCPackage.ELSE_NODE__MULTI_HIGH;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityModifiers.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_ORDERED: return SysMLOCPackage.ELSE_NODE__IS_ORDERED;
        case SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_NONUNIQUE: return SysMLOCPackage.ELSE_NODE__IS_NONUNIQUE;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityPart.class)
