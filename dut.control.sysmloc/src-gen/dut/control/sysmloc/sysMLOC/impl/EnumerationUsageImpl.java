 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.EnumerationUsageImpl#getCrossEndUsage <em>Cross End Usage</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.EnumerationUsageImpl#isIsConstant <em>Is Constant</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.EnumerationUsageImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationUsageImpl extends NonOccurrenceUsageElementImpl implements EnumerationUsage
{
  ...
  public NotificationChain basicSetCrossEndUsage(CrossEndUsage newCrossEndUsage, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE, oldCrossEndUsage, newCrossEndUsage);
  ...
  public void setCrossEndUsage(CrossEndUsage newCrossEndUsage)
  {
    if (newCrossEndUsage != crossEndUsage)
    {
      ...
      if (crossEndUsage != null)
        msgs = ((InternalEObject)crossEndUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE, null, msgs);
      if (newCrossEndUsage != null)
        msgs = ((InternalEObject)newCrossEndUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE, null, msgs);
      msgs = basicSetCrossEndUsage(newCrossEndUsage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE, newCrossEndUsage, newCrossEndUsage));
  }
  ...
  public void setIsEnd(boolean newIsEnd)
  {
    ...
    isEnd = newIsEnd;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_END, oldIsEnd, isEnd));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public void setDirection(FeatureDirection newDirection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__DIRECTION, oldDirection, direction));
  }
  ...
  public void setIsDerived(boolean newIsDerived)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_DERIVED, oldIsDerived, isDerived));
  }
  ...
  public void setIsConstant(boolean newIsConstant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_CONSTANT, oldIsConstant, isConstant));
  }
  ...
  public void setIsReference(boolean newIsReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_REFERENCE, oldIsReference, isReference));
  }
  ...
  public EList<String> getTypings()
  {
    if (typings == null)
    {
      typings = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ENUMERATION_USAGE__TYPINGS);
    }
    return typings;
  }
  ...
  public EList<String> getSubsetting()
  {
    if (subsetting == null)
    {
      subsetting = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ENUMERATION_USAGE__SUBSETTING);
    }
    return subsetting;
  }
  ...
  public EList<String> getReferences()
  {
    if (references == null)
    {
      references = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ENUMERATION_USAGE__REFERENCES);
    }
    return references;
  }
  ...
  public EList<String> getCrosses()
  {
    if (crosses == null)
    {
      crosses = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ENUMERATION_USAGE__CROSSES);
    }
    return crosses;
  }
  ...
  public EList<String> getRedefinitions()
  {
    ...
    {
      redefinitions = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.ENUMERATION_USAGE__REDEFINITIONS);
    }
  ...
  public void setMultiLow(String newMultiLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__MULTI_LOW, oldMultiLow, multiLow));
  }
  ...
  public void setMultiHigh(String newMultiHigh)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__MULTI_HIGH, oldMultiHigh, multiHigh));
  }
  ...
  public void setIsOrdered(boolean newIsOrdered)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_ORDERED, oldIsOrdered, isOrdered));
  }
  ...
  public void setIsNonunique(boolean newIsNonunique)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_NONUNIQUE, oldIsNonunique, isNonunique));
  }
  ...
  public void setIsInitial(boolean newIsInitial)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_INITIAL, oldIsInitial, isInitial));
  }
  ...
  public void setIsDefault(boolean newIsDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__IS_DEFAULT, oldIsDefault, isDefault));
  }
  ...
  public void setValuePart(String newValuePart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.ENUMERATION_USAGE__VALUE_PART, oldValuePart, valuePart));
  }
  ...
  public EList<UsageBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<UsageBodyElement>(UsageBodyElement.class, this, SysMLOCPackage.ENUMERATION_USAGE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE:
        return basicSetCrossEndUsage(null, msgs);
      case SysMLOCPackage.ENUMERATION_USAGE__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.ENUMERATION_USAGE__IS_ABSTRACT:
        return isIsAbstract();
      case SysMLOCPackage.ENUMERATION_USAGE__IS_VARIATION:
        return isIsVariation();
      case SysMLOCPackage.ENUMERATION_USAGE__DIRECTION:
        return getDirection();
      case SysMLOCPackage.ENUMERATION_USAGE__IS_DERIVED:
        return isIsDerived();
      case SysMLOCPackage.ENUMERATION_USAGE__IS_CONSTANT:
        return isIsConstant();
      ...
      case SysMLOCPackage.ENUMERATION_USAGE__REFERENCES:
        return getReferences();
      case SysMLOCPackage.ENUMERATION_USAGE__CROSSES:
        return getCrosses();
      ...
      case SysMLOCPackage.ENUMERATION_USAGE__MULTI_HIGH:
        return getMultiHigh();
      case SysMLOCPackage.ENUMERATION_USAGE__IS_ORDERED:
        return isIsOrdered();
      ...
      case SysMLOCPackage.ENUMERATION_USAGE__IS_DEFAULT:
        return isIsDefault();
      case SysMLOCPackage.ENUMERATION_USAGE__VALUE_PART:
        return getValuePart();
      case SysMLOCPackage.ENUMERATION_USAGE__ELEMENTS:
        return getElements();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CrossEndUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE: return SysMLOCPackage.CROSS_END_USAGE_PREFIX__CROSS_END_USAGE;
        default: return -1;
      }
    }
    if (baseClass == EndUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__IS_END: return SysMLOCPackage.END_USAGE_PREFIX__IS_END;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.ENUMERATION_USAGE__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__DIRECTION: return SysMLOCPackage.REF_PREFIX__DIRECTION;
        case SysMLOCPackage.ENUMERATION_USAGE__IS_DERIVED: return SysMLOCPackage.REF_PREFIX__IS_DERIVED;
        case SysMLOCPackage.ENUMERATION_USAGE__IS_CONSTANT: return SysMLOCPackage.REF_PREFIX__IS_CONSTANT;
        default: return -1;
      }
    }
    if (baseClass == BasicUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__IS_REFERENCE: return SysMLOCPackage.BASIC_USAGE_PREFIX__IS_REFERENCE;
        default: return -1;
      }
    }
    ...
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__SUBSETTING: return SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__REFERENCES: return SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__CROSSES: return SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__REDEFINITIONS: return SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS;
        default: return -1;
      }
    }
    ...
    if (baseClass == MultiplicityModifiers.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__IS_ORDERED: return SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_ORDERED;
        case SysMLOCPackage.ENUMERATION_USAGE__IS_NONUNIQUE: return SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_NONUNIQUE;
        default: return -1;
      }
    }
    ...
    if (baseClass == FeatureValue.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.ENUMERATION_USAGE__IS_INITIAL: return SysMLOCPackage.FEATURE_VALUE__IS_INITIAL;
        case SysMLOCPackage.ENUMERATION_USAGE__IS_DEFAULT: return SysMLOCPackage.FEATURE_VALUE__IS_DEFAULT;
        case SysMLOCPackage.ENUMERATION_USAGE__VALUE_PART: return SysMLOCPackage.FEATURE_VALUE__VALUE_PART;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == CrossEndUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_END_USAGE_PREFIX__CROSS_END_USAGE: return SysMLOCPackage.ENUMERATION_USAGE__CROSS_END_USAGE;
        default: return -1;
      }
    }
    if (baseClass == EndUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.END_USAGE_PREFIX__IS_END: return SysMLOCPackage.ENUMERATION_USAGE__IS_END;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.ENUMERATION_USAGE__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.ENUMERATION_USAGE__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REF_PREFIX__DIRECTION: return SysMLOCPackage.ENUMERATION_USAGE__DIRECTION;
        case SysMLOCPackage.REF_PREFIX__IS_DERIVED: return SysMLOCPackage.ENUMERATION_USAGE__IS_DERIVED;
        case SysMLOCPackage.REF_PREFIX__IS_CONSTANT: return SysMLOCPackage.ENUMERATION_USAGE__IS_CONSTANT;
        default: return -1;
      }
    }
    if (baseClass == BasicUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_USAGE_PREFIX__IS_REFERENCE: return SysMLOCPackage.ENUMERATION_USAGE__IS_REFERENCE;
        default: return -1;
      }
    }
    if (baseClass == UnextendedUsagePrefix.class)
    ...
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS: return SysMLOCPackage.ENUMERATION_USAGE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING: return SysMLOCPackage.ENUMERATION_USAGE__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES: return SysMLOCPackage.ENUMERATION_USAGE__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES: return SysMLOCPackage.ENUMERATION_USAGE__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS: return SysMLOCPackage.ENUMERATION_USAGE__REDEFINITIONS;
        default: return -1;
      }
    }
    if (baseClass == FeatureSpecialization.class)
    ...
    if (baseClass == MultiplicityModifiers.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_ORDERED: return SysMLOCPackage.ENUMERATION_USAGE__IS_ORDERED;
        case SysMLOCPackage.MULTIPLICITY_MODIFIERS__IS_NONUNIQUE: return SysMLOCPackage.ENUMERATION_USAGE__IS_NONUNIQUE;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityPart.class)
    ...
    if (baseClass == FeatureValue.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.FEATURE_VALUE__IS_INITIAL: return SysMLOCPackage.ENUMERATION_USAGE__IS_INITIAL;
        case SysMLOCPackage.FEATURE_VALUE__IS_DEFAULT: return SysMLOCPackage.ENUMERATION_USAGE__IS_DEFAULT;
        case SysMLOCPackage.FEATURE_VALUE__VALUE_PART: return SysMLOCPackage.ENUMERATION_USAGE__VALUE_PART;
        default: return -1;
      }
    }
    if (baseClass == Usage.class)
