 ...
 * @generated
 */
public class ExhibitStateUsageImpl extends BehaviorUsageElementImpl implements ExhibitStateUsage
{
  /**
  ...
  public EList<String> getValuePart()
  {
    if (valuePart == null)
    {
      valuePart = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.EXHIBIT_STATE_USAGE__VALUE_PART);
    }
    return valuePart;
  }
