 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.FlowDefinitionImpl#getPrefixMetadataExtension <em>Prefix Metadata Extension</em>}</li>
...
public class FlowDefinitionImpl extends DefinitionElementsImpl implements FlowDefinition
{
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.FLOW_DEFINITION__PREFIX_METADATA_EXTENSION);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.FLOW_DEFINITION__PREFIX_METADATA_EXTENSION:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.FLOW_DEFINITION__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.FLOW_DEFINITION__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == DefinitionExtensionKeyword.class)
