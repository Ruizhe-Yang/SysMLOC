 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.IdentificationImpl#getDeclaredShortName <em>Declared Short Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.IdentificationImpl#getDeclaredName <em>Declared Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentificationImpl extends MinimalEObjectImpl.Container implements Identification
{
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.IDENTIFICATION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME:
        return getDeclaredShortName();
      case SysMLOCPackage.IDENTIFICATION__DECLARED_NAME:
