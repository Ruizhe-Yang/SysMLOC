 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.IndividualDefinitionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndividualDefinitionImpl extends DefinitionElementsImpl implements IndividualDefinition
{
  /**
  ...
  {
    return SysMLOCPackage.eINSTANCE.getIndividualDefinition();
  }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.INDIVIDUAL_DEFINITION__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.INDIVIDUAL_DEFINITION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<String> getSuperclassifiers()
  {
    ...
    {
      superclassifiers = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.INDIVIDUAL_DEFINITION__SUPERCLASSIFIERS);
    }
  ...
  public void setIsIndividual(boolean newIsIndividual)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_INDIVIDUAL, oldIsIndividual, isIndividual));
  }
  ...
  public EList<DefinitionBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<DefinitionBodyElement>(DefinitionBodyElement.class, this, SysMLOCPackage.INDIVIDUAL_DEFINITION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.INDIVIDUAL_DEFINITION__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_INDIVIDUAL:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.INDIVIDUAL_DEFINITION__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
