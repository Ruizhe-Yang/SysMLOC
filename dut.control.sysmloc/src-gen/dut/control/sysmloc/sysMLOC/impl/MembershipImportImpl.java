 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MembershipImportImpl#isIsImportAll <em>Is Import All</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MembershipImportImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MembershipImportImpl#getDeclaredName <em>Declared Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MembershipImportImpl#isIsRecursive <em>Is Recursive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MembershipImportImpl extends ImportElementImpl implements MembershipImport
{
  /**
  ...
  public void setIsImportAll(boolean newIsImportAll)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MEMBERSHIP_IMPORT__IS_IMPORT_ALL, oldIsImportAll, isImportAll));
  }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MEMBERSHIP_IMPORT__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MEMBERSHIP_IMPORT__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public void setIsRecursive(boolean newIsRecursive)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MEMBERSHIP_IMPORT__IS_RECURSIVE, oldIsRecursive, isRecursive));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SysMLOCPackage.MEMBERSHIP_IMPORT__IS_IMPORT_ALL:
        return isIsImportAll();
      case SysMLOCPackage.MEMBERSHIP_IMPORT__VISIBILITY:
        return getVisibility();
      case SysMLOCPackage.MEMBERSHIP_IMPORT__DECLARED_NAME:
        return getDeclaredName();
      case SysMLOCPackage.MEMBERSHIP_IMPORT__IS_RECURSIVE:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == isImportAllFragment.class)
    {
      ...
      {
        case SysMLOCPackage.MEMBERSHIP_IMPORT__IS_IMPORT_ALL: return SysMLOCPackage.IS_IMPORT_ALL_FRAGMENT__IS_IMPORT_ALL;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == isImportAllFragment.class)
    {
      ...
      {
        case SysMLOCPackage.IS_IMPORT_ALL_FRAGMENT__IS_IMPORT_ALL: return SysMLOCPackage.MEMBERSHIP_IMPORT__IS_IMPORT_ALL;
        default: return -1;
      }
    }
