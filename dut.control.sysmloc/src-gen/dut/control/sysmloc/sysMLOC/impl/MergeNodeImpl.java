 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#isIsThen <em>Is Then</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getThenMultiplicity <em>Then Multiplicity</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#isIsVariation <em>Is Variation</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#isIsReadOnly <em>Is Read Only</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getCrosses <em>Crosses</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getRedefinitions <em>Redefinitions</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#isIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#isIsNonunique <em>Is Nonunique</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getDeclaredName <em>Declared Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MergeNodeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MergeNodeImpl extends ActionNodeElementImpl implements MergeNode
{
  /**
  ...
  {
    return SysMLOCPackage.eINSTANCE.getMergeNode();
  }
  ...
  public void setIsThen(boolean newIsThen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_THEN, oldIsThen, isThen));
  }
  ...
  public EList<String> getThenMultiplicity()
  {
    ...
    {
      thenMultiplicity = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__THEN_MULTIPLICITY);
    }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setDirection(FeatureDirection newDirection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__DIRECTION, oldDirection, direction));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public void setIsReadOnly(boolean newIsReadOnly)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_READ_ONLY, oldIsReadOnly, isReadOnly));
  }
  ...
  public void setIsDerived(boolean newIsDerived)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_DERIVED, oldIsDerived, isDerived));
  }
  ...
  public void setIsIndividual(boolean newIsIndividual)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_INDIVIDUAL, oldIsIndividual, isIndividual));
  }
  ...
  public void setPortionKind(PortionKind newPortionKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__PORTION_KIND, oldPortionKind, portionKind));
  }
  ...
  public EList<String> getTypings()
  {
    if (typings == null)
    {
      typings = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__TYPINGS);
    }
    return typings;
  }
  ...
  public EList<String> getSubsetting()
  {
    if (subsetting == null)
    {
      subsetting = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__SUBSETTING);
    }
    return subsetting;
  }
  ...
  public EList<String> getReferences()
  {
    if (references == null)
    {
      references = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__REFERENCES);
    }
    return references;
  }
  ...
  public EList<String> getCrosses()
  {
    if (crosses == null)
    {
      crosses = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__CROSSES);
    }
    return crosses;
  }
  ...
  public EList<String> getRedefinitions()
  {
    ...
    {
      redefinitions = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__REDEFINITIONS);
    }
  ...
  public EList<String> getMultiplicity()
  {
    ...
    {
      multiplicity = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MERGE_NODE__MULTIPLICITY);
    }
    return multiplicity;
  }
  ...
  public void setIsOrdered(boolean newIsOrdered)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_ORDERED, oldIsOrdered, isOrdered));
  }
  ...
  public void setIsNonunique(boolean newIsNonunique)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__IS_NONUNIQUE, oldIsNonunique, isNonunique));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MERGE_NODE__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<ActionNodeBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<ActionNodeBodyElement>(ActionNodeBodyElement.class, this, SysMLOCPackage.MERGE_NODE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.MERGE_NODE__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SysMLOCPackage.MERGE_NODE__IS_THEN:
        return isIsThen();
      case SysMLOCPackage.MERGE_NODE__THEN_MULTIPLICITY:
        return getThenMultiplicity();
      case SysMLOCPackage.MERGE_NODE__VISIBILITY:
        return getVisibility();
      case SysMLOCPackage.MERGE_NODE__DIRECTION:
        return getDirection();
      case SysMLOCPackage.MERGE_NODE__IS_ABSTRACT:
        return isIsAbstract();
      case SysMLOCPackage.MERGE_NODE__IS_VARIATION:
        return isIsVariation();
      case SysMLOCPackage.MERGE_NODE__IS_READ_ONLY:
        return isIsReadOnly();
      case SysMLOCPackage.MERGE_NODE__IS_DERIVED:
        return isIsDerived();
      case SysMLOCPackage.MERGE_NODE__USAGE_EXTENSION:
        return getUsageExtension();
      case SysMLOCPackage.MERGE_NODE__IS_INDIVIDUAL:
      ...
      case SysMLOCPackage.MERGE_NODE__REFERENCES:
        return getReferences();
      case SysMLOCPackage.MERGE_NODE__CROSSES:
        return getCrosses();
      case SysMLOCPackage.MERGE_NODE__REDEFINITIONS:
        return getRedefinitions();
      case SysMLOCPackage.MERGE_NODE__MULTIPLICITY:
        return getMultiplicity();
      case SysMLOCPackage.MERGE_NODE__IS_ORDERED:
        return isIsOrdered();
      case SysMLOCPackage.MERGE_NODE__IS_NONUNIQUE:
        return isIsNonunique();
      case SysMLOCPackage.MERGE_NODE__DECLARED_NAME:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == EmptySuccessionPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.MERGE_NODE__IS_THEN: return SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__IS_THEN;
        case SysMLOCPackage.MERGE_NODE__THEN_MULTIPLICITY: return SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTIPLICITY;
        default: return -1;
      }
    }
    if (baseClass == MemberPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__VISIBILITY: return SysMLOCPackage.MEMBER_PREFIX__VISIBILITY;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__DIRECTION: return SysMLOCPackage.REF_PREFIX__DIRECTION;
        case SysMLOCPackage.MERGE_NODE__IS_ABSTRACT: return SysMLOCPackage.REF_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.MERGE_NODE__IS_VARIATION: return SysMLOCPackage.REF_PREFIX__IS_VARIATION;
        case SysMLOCPackage.MERGE_NODE__IS_READ_ONLY: return SysMLOCPackage.REF_PREFIX__IS_READ_ONLY;
        case SysMLOCPackage.MERGE_NODE__IS_DERIVED: return SysMLOCPackage.REF_PREFIX__IS_DERIVED;
        default: return -1;
      }
    }
    if (baseClass == UsageExtensionKeyword.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__USAGE_EXTENSION: return SysMLOCPackage.USAGE_EXTENSION_KEYWORD__USAGE_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == FeatureSpecialization.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__TYPINGS: return SysMLOCPackage.FEATURE_SPECIALIZATION__TYPINGS;
        case SysMLOCPackage.MERGE_NODE__SUBSETTING: return SysMLOCPackage.FEATURE_SPECIALIZATION__SUBSETTING;
        case SysMLOCPackage.MERGE_NODE__REFERENCES: return SysMLOCPackage.FEATURE_SPECIALIZATION__REFERENCES;
        case SysMLOCPackage.MERGE_NODE__CROSSES: return SysMLOCPackage.FEATURE_SPECIALIZATION__CROSSES;
        case SysMLOCPackage.MERGE_NODE__REDEFINITIONS: return SysMLOCPackage.FEATURE_SPECIALIZATION__REDEFINITIONS;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityRange.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__MULTIPLICITY: return SysMLOCPackage.MULTIPLICITY_RANGE__MULTIPLICITY;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityPart.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__IS_ORDERED: return SysMLOCPackage.MULTIPLICITY_PART__IS_ORDERED;
        case SysMLOCPackage.MERGE_NODE__IS_NONUNIQUE: return SysMLOCPackage.MULTIPLICITY_PART__IS_NONUNIQUE;
        default: return -1;
      }
    }
    ...
    if (baseClass == FeatureDeclaration.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MERGE_NODE__DECLARED_NAME: return SysMLOCPackage.FEATURE_DECLARATION__DECLARED_NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == EmptySuccessionPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__IS_THEN: return SysMLOCPackage.MERGE_NODE__IS_THEN;
        case SysMLOCPackage.EMPTY_SUCCESSION_PREFIX__THEN_MULTIPLICITY: return SysMLOCPackage.MERGE_NODE__THEN_MULTIPLICITY;
        default: return -1;
      }
    }
    if (baseClass == MemberPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MEMBER_PREFIX__VISIBILITY: return SysMLOCPackage.MERGE_NODE__VISIBILITY;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REF_PREFIX__DIRECTION: return SysMLOCPackage.MERGE_NODE__DIRECTION;
        case SysMLOCPackage.REF_PREFIX__IS_ABSTRACT: return SysMLOCPackage.MERGE_NODE__IS_ABSTRACT;
        case SysMLOCPackage.REF_PREFIX__IS_VARIATION: return SysMLOCPackage.MERGE_NODE__IS_VARIATION;
        case SysMLOCPackage.REF_PREFIX__IS_READ_ONLY: return SysMLOCPackage.MERGE_NODE__IS_READ_ONLY;
        case SysMLOCPackage.REF_PREFIX__IS_DERIVED: return SysMLOCPackage.MERGE_NODE__IS_DERIVED;
        default: return -1;
      }
    }
    if (baseClass == UsageExtensionKeyword.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.USAGE_EXTENSION_KEYWORD__USAGE_EXTENSION: return SysMLOCPackage.MERGE_NODE__USAGE_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == ControlNodePrefix.class)
    ...
    if (baseClass == FeatureSpecialization.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.FEATURE_SPECIALIZATION__TYPINGS: return SysMLOCPackage.MERGE_NODE__TYPINGS;
        case SysMLOCPackage.FEATURE_SPECIALIZATION__SUBSETTING: return SysMLOCPackage.MERGE_NODE__SUBSETTING;
        case SysMLOCPackage.FEATURE_SPECIALIZATION__REFERENCES: return SysMLOCPackage.MERGE_NODE__REFERENCES;
        case SysMLOCPackage.FEATURE_SPECIALIZATION__CROSSES: return SysMLOCPackage.MERGE_NODE__CROSSES;
        case SysMLOCPackage.FEATURE_SPECIALIZATION__REDEFINITIONS: return SysMLOCPackage.MERGE_NODE__REDEFINITIONS;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityRange.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MULTIPLICITY_RANGE__MULTIPLICITY: return SysMLOCPackage.MERGE_NODE__MULTIPLICITY;
        default: return -1;
      }
    }
    if (baseClass == MultiplicityPart.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.MULTIPLICITY_PART__IS_ORDERED: return SysMLOCPackage.MERGE_NODE__IS_ORDERED;
        case SysMLOCPackage.MULTIPLICITY_PART__IS_NONUNIQUE: return SysMLOCPackage.MERGE_NODE__IS_NONUNIQUE;
        default: return -1;
      }
    }
    if (baseClass == FeatureSpecializationPart.class)
    ...
    if (baseClass == FeatureDeclaration.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.FEATURE_DECLARATION__DECLARED_NAME: return SysMLOCPackage.MERGE_NODE__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == UsageDeclaration.class)
