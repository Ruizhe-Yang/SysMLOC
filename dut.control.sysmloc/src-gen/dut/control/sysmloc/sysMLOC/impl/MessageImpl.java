 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MessageImpl#getCrossEndUsage <em>Cross End Usage</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MessageImpl#getItemFeatureParameter <em>Item Feature Parameter</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MessageImpl#getFlowEnd <em>Flow End</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.MessageImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageImpl extends StructureUsageElementsImpl implements Message
{
  /**
  ...
  {
    return SysMLOCPackage.eINSTANCE.getMessage();
  }
  ...
  public void setIsThen(boolean newIsThen)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_THEN, oldIsThen, isThen));
  }
  ...
  public void setIsReturn(boolean newIsReturn)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_RETURN, oldIsReturn, isReturn));
  }
  ...
  public NotificationChain basicSetCrossEndUsage(CrossEndUsage newCrossEndUsage, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__CROSS_END_USAGE, oldCrossEndUsage, newCrossEndUsage);
  ...
  public void setCrossEndUsage(CrossEndUsage newCrossEndUsage)
  {
    if (newCrossEndUsage != crossEndUsage)
    {
      ...
      if (crossEndUsage != null)
        msgs = ((InternalEObject)crossEndUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.MESSAGE__CROSS_END_USAGE, null, msgs);
      if (newCrossEndUsage != null)
        msgs = ((InternalEObject)newCrossEndUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.MESSAGE__CROSS_END_USAGE, null, msgs);
      msgs = basicSetCrossEndUsage(newCrossEndUsage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__CROSS_END_USAGE, newCrossEndUsage, newCrossEndUsage));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public void setDirection(FeatureDirection newDirection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__DIRECTION, oldDirection, direction));
  }
  ...
  public void setIsReference(boolean newIsReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_REFERENCE, oldIsReference, isReference));
  }
  ...
  public void setIsIndividual(boolean newIsIndividual)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_INDIVIDUAL, oldIsIndividual, isIndividual));
  }
  ...
  public void setPortionKind(PortionKind newPortionKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__PORTION_KIND, oldPortionKind, portionKind));
  }
  ...
  public EList<String> getTypings()
  {
    if (typings == null)
    {
      typings = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MESSAGE__TYPINGS);
    }
    return typings;
  }
  ...
  public EList<String> getSubsetting()
  {
    if (subsetting == null)
    {
      subsetting = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MESSAGE__SUBSETTING);
    }
    return subsetting;
  }
  ...
  public EList<String> getReferences()
  {
    if (references == null)
    {
      references = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MESSAGE__REFERENCES);
    }
    return references;
  }
  ...
  public EList<String> getCrosses()
  {
    if (crosses == null)
    {
      crosses = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MESSAGE__CROSSES);
    }
    return crosses;
  }
  ...
  public EList<String> getRedefinitions()
  {
    ...
    {
      redefinitions = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MESSAGE__REDEFINITIONS);
    }
  ...
  public void setIsOrdered(boolean newIsOrdered)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_ORDERED, oldIsOrdered, isOrdered));
  }
  ...
  public void setIsInitial(boolean newIsInitial)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_INITIAL, oldIsInitial, isInitial));
  }
  ...
  public void setIsDefault(boolean newIsDefault)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__IS_DEFAULT, oldIsDefault, isDefault));
  }
  ...
  public void setValuePart(String newValuePart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__VALUE_PART, oldValuePart, valuePart));
  }
  ...
  public NotificationChain basicSetItemFeatureParameter(ItemFeatureParameter newItemFeatureParameter, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER, oldItemFeatureParameter, newItemFeatureParameter);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setItemFeatureParameter(ItemFeatureParameter newItemFeatureParameter)
  {
    if (newItemFeatureParameter != itemFeatureParameter)
    {
      ...
      if (itemFeatureParameter != null)
        msgs = ((InternalEObject)itemFeatureParameter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER, null, msgs);
      if (newItemFeatureParameter != null)
        msgs = ((InternalEObject)newItemFeatureParameter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER, null, msgs);
      msgs = basicSetItemFeatureParameter(newItemFeatureParameter, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER, newItemFeatureParameter, newItemFeatureParameter));
  }
  ...
  public EList<String> getFlowEnd()
  {
    if (flowEnd == null)
    {
      flowEnd = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.MESSAGE__FLOW_END);
    }
    return flowEnd;
  }
  ...
  public EList<UsageBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<UsageBodyElement>(UsageBodyElement.class, this, SysMLOCPackage.MESSAGE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.MESSAGE__CROSS_END_USAGE:
        return basicSetCrossEndUsage(null, msgs);
      case SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER:
        return basicSetItemFeatureParameter(null, msgs);
      case SysMLOCPackage.MESSAGE__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.MESSAGE__REFERENCES:
        return getReferences();
      case SysMLOCPackage.MESSAGE__CROSSES:
        return getCrosses();
      ...
      case SysMLOCPackage.MESSAGE__IS_DEFAULT:
        return isIsDefault();
      case SysMLOCPackage.MESSAGE__VALUE_PART:
        return getValuePart();
      case SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER:
        return getItemFeatureParameter();
      case SysMLOCPackage.MESSAGE__FLOW_END:
        return getFlowEnd();
      case SysMLOCPackage.MESSAGE__ELEMENTS:
        return getElements();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == isReturnPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__IS_RETURN: return SysMLOCPackage.IS_RETURN_PREFIX__IS_RETURN;
        default: return -1;
      }
    }
    ...
    if (baseClass == CrossEndUsagePrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__CROSS_END_USAGE: return SysMLOCPackage.CROSS_END_USAGE_PREFIX__CROSS_END_USAGE;
        default: return -1;
      }
    }
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.MESSAGE__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    ...
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__SUBSETTING: return SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__REFERENCES: return SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__CROSSES: return SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__REDEFINITIONS: return SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS;
        default: return -1;
      }
    }
    ...
    if (baseClass == FeatureValue.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__IS_INITIAL: return SysMLOCPackage.FEATURE_VALUE__IS_INITIAL;
        case SysMLOCPackage.MESSAGE__IS_DEFAULT: return SysMLOCPackage.FEATURE_VALUE__IS_DEFAULT;
        case SysMLOCPackage.MESSAGE__VALUE_PART: return SysMLOCPackage.FEATURE_VALUE__VALUE_PART;
        default: return -1;
      }
    }
    ...
    if (baseClass == ItemFeatureParameterPart.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER: return SysMLOCPackage.ITEM_FEATURE_PARAMETER_PART__ITEM_FEATURE_PARAMETER;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == isReturnPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.IS_RETURN_PREFIX__IS_RETURN: return SysMLOCPackage.MESSAGE__IS_RETURN;
        default: return -1;
      }
    }
    if (baseClass == GeneralUsagePrefix.class)
    ...
    if (baseClass == CrossEndUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_END_USAGE_PREFIX__CROSS_END_USAGE: return SysMLOCPackage.MESSAGE__CROSS_END_USAGE;
        default: return -1;
      }
    }
    if (baseClass == EndUsagePrefix.class)
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.MESSAGE__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.MESSAGE__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == RefPrefix.class)
    ...
    if (baseClass == BasicUsagePrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_USAGE_PREFIX__IS_REFERENCE: return SysMLOCPackage.MESSAGE__IS_REFERENCE;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    ...
    if (baseClass == TypingFeatureTyping.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_TYPING__TYPINGS: return SysMLOCPackage.MESSAGE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.SUBSETTING_FEATURE_CHAIN__SUBSETTING: return SysMLOCPackage.MESSAGE__SUBSETTING;
        default: return -1;
      }
    }
    if (baseClass == ReferenceFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REFERENCE_FEATURE_CHAIN__REFERENCES: return SysMLOCPackage.MESSAGE__REFERENCES;
        default: return -1;
      }
    }
    if (baseClass == CrossFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.CROSS_FEATURE_CHAIN__CROSSES: return SysMLOCPackage.MESSAGE__CROSSES;
        default: return -1;
      }
    }
    if (baseClass == RedefinitionFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.REDEFINITION_FEATURE_CHAIN__REDEFINITIONS: return SysMLOCPackage.MESSAGE__REDEFINITIONS;
        default: return -1;
      }
    }
    if (baseClass == FeatureSpecialization.class)
    ...
    if (baseClass == FeatureValue.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.FEATURE_VALUE__IS_INITIAL: return SysMLOCPackage.MESSAGE__IS_INITIAL;
        case SysMLOCPackage.FEATURE_VALUE__IS_DEFAULT: return SysMLOCPackage.MESSAGE__IS_DEFAULT;
        case SysMLOCPackage.FEATURE_VALUE__VALUE_PART: return SysMLOCPackage.MESSAGE__VALUE_PART;
        default: return -1;
      }
    }
    if (baseClass == ValuePart.class)
    ...
    if (baseClass == ItemFeatureParameterPart.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.ITEM_FEATURE_PARAMETER_PART__ITEM_FEATURE_PARAMETER: return SysMLOCPackage.MESSAGE__ITEM_FEATURE_PARAMETER;
        default: return -1;
      }
    }
