 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#isIsVariant <em>Is Variant</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#isIsVariation <em>Is Variation</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#getPrefixMetadataExtension <em>Prefix Metadata Extension</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#isIsIndividual <em>Is Individual</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#getDeclaredShortName <em>Declared Short Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#getDeclaredName <em>Declared Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#getSuperclassifiers <em>Superclassifiers</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.OccurrenceDefinitionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OccurrenceDefinitionImpl extends DefinitionElementImpl implements OccurrenceDefinition
{
  ...
  {
    return SysMLOCPackage.eINSTANCE.getOccurrenceDefinition();
  }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.OCCURRENCE_DEFINITION__PREFIX_METADATA_EXTENSION);
    }
  ...
  public void setIsIndividual(boolean newIsIndividual)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__IS_INDIVIDUAL, oldIsIndividual, isIndividual));
  }
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<String> getSuperclassifiers()
  {
    ...
    {
      superclassifiers = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.OCCURRENCE_DEFINITION__SUPERCLASSIFIERS);
    }
  ...
  public EList<DefinitionBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<DefinitionBodyElement>(DefinitionBodyElement.class, this, SysMLOCPackage.OCCURRENCE_DEFINITION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.OCCURRENCE_DEFINITION__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SysMLOCPackage.OCCURRENCE_DEFINITION__VISIBILITY:
        return getVisibility();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIANT:
        return isIsVariant();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_ABSTRACT:
        return isIsAbstract();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIATION:
        return isIsVariation();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__PREFIX_METADATA_EXTENSION:
        return getPrefixMetadataExtension();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_INDIVIDUAL:
        return isIsIndividual();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_SHORT_NAME:
        return getDeclaredShortName();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_NAME:
        return getDeclaredName();
      case SysMLOCPackage.OCCURRENCE_DEFINITION__SUPERCLASSIFIERS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION__VISIBILITY: return SysMLOCPackage.MEMBER_PREFIX__VISIBILITY;
        case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIANT: return SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == OccurrenceDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION__IS_INDIVIDUAL: return SysMLOCPackage.OCCURRENCE_DEFINITION_PREFIX__IS_INDIVIDUAL;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_SHORT_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION__SUPERCLASSIFIERS: return SysMLOCPackage.DEFINITION_DECLARATION__SUPERCLASSIFIERS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.MEMBER_PREFIX__VISIBILITY: return SysMLOCPackage.OCCURRENCE_DEFINITION__VISIBILITY;
        case SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT: return SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.OCCURRENCE_DEFINITION__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.OCCURRENCE_DEFINITION__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.OCCURRENCE_DEFINITION__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == DefinitionExtensionKeyword.class)
    ...
    if (baseClass == OccurrenceDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION_PREFIX__IS_INDIVIDUAL: return SysMLOCPackage.OCCURRENCE_DEFINITION__IS_INDIVIDUAL;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME: return SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.IDENTIFICATION__DECLARED_NAME: return SysMLOCPackage.OCCURRENCE_DEFINITION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.DEFINITION_DECLARATION__SUPERCLASSIFIERS: return SysMLOCPackage.OCCURRENCE_DEFINITION__SUPERCLASSIFIERS;
        default: return -1;
      }
    }
