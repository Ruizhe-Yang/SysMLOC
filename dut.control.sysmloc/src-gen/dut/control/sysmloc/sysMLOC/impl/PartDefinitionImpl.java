 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.PartDefinitionImpl#getPrefixMetadataExtension <em>Prefix Metadata Extension</em>}</li>
 ...
 * @generated
 */
public class PartDefinitionImpl extends DefinitionElementsImpl implements PartDefinition
{
  /**
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PART_DEFINITION__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PART_DEFINITION__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PART_DEFINITION__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.PART_DEFINITION__PREFIX_METADATA_EXTENSION);
    }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PART_DEFINITION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<String> getSuperclassifiers()
  {
    ...
    {
      superclassifiers = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.PART_DEFINITION__SUPERCLASSIFIERS);
    }
  ...
  public EList<DefinitionBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<DefinitionBodyElement>(DefinitionBodyElement.class, this, SysMLOCPackage.PART_DEFINITION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.PART_DEFINITION__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.PART_DEFINITION__PREFIX_METADATA_EXTENSION:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PART_DEFINITION__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.PART_DEFINITION__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PART_DEFINITION__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == OccurrenceDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PART_DEFINITION__IS_INDIVIDUAL: return SysMLOCPackage.OCCURRENCE_DEFINITION_PREFIX__IS_INDIVIDUAL;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.PART_DEFINITION__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.PART_DEFINITION__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PART_DEFINITION__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == DefinitionExtensionKeyword.class)
    ...
    if (baseClass == OccurrenceDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION_PREFIX__IS_INDIVIDUAL: return SysMLOCPackage.PART_DEFINITION__IS_INDIVIDUAL;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
