...
public class PortDefinitionImpl extends DefinitionElementImpl implements PortDefinition
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PORT_DEFINITION__DECLARED_NAME: return SysMLOCPackage.DEFINITION_DECLARATION__DECLARED_NAME;
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.DEFINITION_DECLARATION__DECLARED_NAME: return SysMLOCPackage.PORT_DEFINITION__DECLARED_NAME;
