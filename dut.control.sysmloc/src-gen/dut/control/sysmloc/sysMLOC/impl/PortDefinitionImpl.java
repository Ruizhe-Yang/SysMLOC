 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.PortDefinitionImpl#isIsVariant <em>Is Variant</em>}</li>
 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.PortDefinitionImpl#getPrefixMetadataExtension <em>Prefix Metadata Extension</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.PortDefinitionImpl#getDeclaredShortName <em>Declared Short Name</em>}</li>
...
public class PortDefinitionImpl extends DefinitionElementImpl implements PortDefinition
{
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PORT_DEFINITION__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.PORT_DEFINITION__PREFIX_METADATA_EXTENSION);
    }
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PORT_DEFINITION__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.PORT_DEFINITION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<String> getSuperclassifiers()
  {
    ...
    {
      superclassifiers = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.PORT_DEFINITION__SUPERCLASSIFIERS);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.PORT_DEFINITION__IS_VARIANT:
        return isIsVariant();
      case SysMLOCPackage.PORT_DEFINITION__IS_ABSTRACT:
        return isIsAbstract();
      case SysMLOCPackage.PORT_DEFINITION__IS_VARIATION:
        return isIsVariation();
      case SysMLOCPackage.PORT_DEFINITION__PREFIX_METADATA_EXTENSION:
        return getPrefixMetadataExtension();
      case SysMLOCPackage.PORT_DEFINITION__DECLARED_SHORT_NAME:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      switch (derivedFeatureID)
      {
        ...
        case SysMLOCPackage.PORT_DEFINITION__IS_VARIANT: return SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT;
        default: return -1;
      }
    }
    ...
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PORT_DEFINITION__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == Identification.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PORT_DEFINITION__DECLARED_SHORT_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.PORT_DEFINITION__DECLARED_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.PORT_DEFINITION__SUPERCLASSIFIERS: return SysMLOCPackage.DEFINITION_DECLARATION__SUPERCLASSIFIERS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      switch (baseFeatureID)
      {
        ...
        case SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT: return SysMLOCPackage.PORT_DEFINITION__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    ...
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PORT_DEFINITION__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == DefinitionExtensionKeyword.class)
    ...
    if (baseClass == Identification.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME: return SysMLOCPackage.PORT_DEFINITION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.IDENTIFICATION__DECLARED_NAME: return SysMLOCPackage.PORT_DEFINITION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.DEFINITION_DECLARATION__SUPERCLASSIFIERS: return SysMLOCPackage.PORT_DEFINITION__SUPERCLASSIFIERS;
        default: return -1;
      }
    }
