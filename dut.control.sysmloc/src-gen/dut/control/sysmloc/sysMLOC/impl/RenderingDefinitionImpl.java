 ...
 * </p>
 * <ul>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#isIsVariant <em>Is Variant</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#isIsVariation <em>Is Variation</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#getPrefixMetadataExtension <em>Prefix Metadata Extension</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#isIsIndividual <em>Is Individual</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#getDeclaredShortName <em>Declared Short Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#getDeclaredName <em>Declared Name</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#getSuperclassifiers <em>Superclassifiers</em>}</li>
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.RenderingDefinitionImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RenderingDefinitionImpl extends DefinitionElementImpl implements RenderingDefinition
{
  ...
  {
    return SysMLOCPackage.eINSTANCE.getRenderingDefinition();
  }
  ...
  public void setVisibility(VisibilityIndicator newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setIsVariant(boolean newIsVariant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__IS_VARIANT, oldIsVariant, isVariant));
  }
  ...
  public void setIsAbstract(boolean newIsAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__IS_ABSTRACT, oldIsAbstract, isAbstract));
  }
  ...
  public void setIsVariation(boolean newIsVariation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__IS_VARIATION, oldIsVariation, isVariation));
  }
  ...
  public EList<String> getPrefixMetadataExtension()
  {
    ...
    {
      prefixMetadataExtension = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.RENDERING_DEFINITION__PREFIX_METADATA_EXTENSION);
    }
  ...
  public void setIsIndividual(boolean newIsIndividual)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__IS_INDIVIDUAL, oldIsIndividual, isIndividual));
  }
  ...
  public void setDeclaredShortName(String newDeclaredShortName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__DECLARED_SHORT_NAME, oldDeclaredShortName, declaredShortName));
  }
  ...
  public void setDeclaredName(String newDeclaredName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SysMLOCPackage.RENDERING_DEFINITION__DECLARED_NAME, oldDeclaredName, declaredName));
  }
  ...
  public EList<String> getSuperclassifiers()
  {
    ...
    {
      superclassifiers = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.RENDERING_DEFINITION__SUPERCLASSIFIERS);
    }
  ...
  public EList<DefinitionBodyElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<DefinitionBodyElement>(DefinitionBodyElement.class, this, SysMLOCPackage.RENDERING_DEFINITION__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SysMLOCPackage.RENDERING_DEFINITION__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SysMLOCPackage.RENDERING_DEFINITION__VISIBILITY:
        return getVisibility();
      case SysMLOCPackage.RENDERING_DEFINITION__IS_VARIANT:
        return isIsVariant();
      case SysMLOCPackage.RENDERING_DEFINITION__IS_ABSTRACT:
        return isIsAbstract();
      case SysMLOCPackage.RENDERING_DEFINITION__IS_VARIATION:
        return isIsVariation();
      case SysMLOCPackage.RENDERING_DEFINITION__PREFIX_METADATA_EXTENSION:
        return getPrefixMetadataExtension();
      case SysMLOCPackage.RENDERING_DEFINITION__IS_INDIVIDUAL:
        return isIsIndividual();
      case SysMLOCPackage.RENDERING_DEFINITION__DECLARED_SHORT_NAME:
        return getDeclaredShortName();
      case SysMLOCPackage.RENDERING_DEFINITION__DECLARED_NAME:
        return getDeclaredName();
      case SysMLOCPackage.RENDERING_DEFINITION__SUPERCLASSIFIERS:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.RENDERING_DEFINITION__VISIBILITY: return SysMLOCPackage.MEMBER_PREFIX__VISIBILITY;
        case SysMLOCPackage.RENDERING_DEFINITION__IS_VARIANT: return SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.RENDERING_DEFINITION__IS_ABSTRACT: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT;
        case SysMLOCPackage.RENDERING_DEFINITION__IS_VARIATION: return SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.RENDERING_DEFINITION__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    ...
    if (baseClass == OccurrenceDefinitionPrefix.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.RENDERING_DEFINITION__IS_INDIVIDUAL: return SysMLOCPackage.OCCURRENCE_DEFINITION_PREFIX__IS_INDIVIDUAL;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.RENDERING_DEFINITION__DECLARED_SHORT_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.RENDERING_DEFINITION__DECLARED_NAME: return SysMLOCPackage.IDENTIFICATION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.RENDERING_DEFINITION__SUPERCLASSIFIERS: return SysMLOCPackage.DEFINITION_DECLARATION__SUPERCLASSIFIERS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == MemberPrefix.class)
    {
      ...
      {
        case SysMLOCPackage.MEMBER_PREFIX__VISIBILITY: return SysMLOCPackage.RENDERING_DEFINITION__VISIBILITY;
        case SysMLOCPackage.MEMBER_PREFIX__IS_VARIANT: return SysMLOCPackage.RENDERING_DEFINITION__IS_VARIANT;
        default: return -1;
      }
    }
    if (baseClass == BasicDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_ABSTRACT: return SysMLOCPackage.RENDERING_DEFINITION__IS_ABSTRACT;
        case SysMLOCPackage.BASIC_DEFINITION_PREFIX__IS_VARIATION: return SysMLOCPackage.RENDERING_DEFINITION__IS_VARIATION;
        default: return -1;
      }
    }
    if (baseClass == PrefixMetadata.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.PREFIX_METADATA__PREFIX_METADATA_EXTENSION: return SysMLOCPackage.RENDERING_DEFINITION__PREFIX_METADATA_EXTENSION;
        default: return -1;
      }
    }
    if (baseClass == DefinitionExtensionKeyword.class)
    ...
    if (baseClass == OccurrenceDefinitionPrefix.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.OCCURRENCE_DEFINITION_PREFIX__IS_INDIVIDUAL: return SysMLOCPackage.RENDERING_DEFINITION__IS_INDIVIDUAL;
        default: return -1;
      }
    }
    if (baseClass == Identification.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.IDENTIFICATION__DECLARED_SHORT_NAME: return SysMLOCPackage.RENDERING_DEFINITION__DECLARED_SHORT_NAME;
        case SysMLOCPackage.IDENTIFICATION__DECLARED_NAME: return SysMLOCPackage.RENDERING_DEFINITION__DECLARED_NAME;
        default: return -1;
      }
    }
    if (baseClass == DefinitionDeclaration.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.DEFINITION_DECLARATION__SUPERCLASSIFIERS: return SysMLOCPackage.RENDERING_DEFINITION__SUPERCLASSIFIERS;
        default: return -1;
      }
    }
