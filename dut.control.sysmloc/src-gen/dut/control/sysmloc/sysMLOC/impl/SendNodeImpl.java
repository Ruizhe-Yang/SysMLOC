 ...
 *   <li>{@link dut.control.sysmloc.sysMLOC.impl.SendNodeImpl#getMultiplicity <em>Multiplicity</em>}</li>
...
public class SendNodeImpl extends ActionNodeElementsImpl implements SendNode
{
  ...
  public EList<String> getMultiplicity()
  {
    ...
    {
      multiplicity = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.SEND_NODE__MULTIPLICITY);
    }
    return multiplicity;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SysMLOCPackage.SEND_NODE__MULTIPLICITY:
