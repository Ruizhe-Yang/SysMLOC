...
public class SuccessionAsUsageImpl extends NonOccurrenceUsageElementImpl implements SuccessionAsUsage
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == TypingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.SUCCESSION_AS_USAGE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_CHAIN__TYPINGS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == TypingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_CHAIN__TYPINGS: return SysMLOCPackage.SUCCESSION_AS_USAGE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
