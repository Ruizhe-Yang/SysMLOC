...
public class TerminateNodeImpl extends ActionNodeElementsImpl implements TerminateNode
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == TypingFeatureChain.class)
    {
      switch (derivedFeatureID)
      {
        case SysMLOCPackage.TERMINATE_NODE__TYPINGS: return SysMLOCPackage.TYPING_FEATURE_CHAIN__TYPINGS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == TypingFeatureChain.class)
    {
      switch (baseFeatureID)
      {
        case SysMLOCPackage.TYPING_FEATURE_CHAIN__TYPINGS: return SysMLOCPackage.TERMINATE_NODE__TYPINGS;
        default: return -1;
      }
    }
    if (baseClass == SubsettingFeatureChain.class)
