 ...
 * @generated
 */
public class ViewUsageImpl extends StructureUsageElementImpl implements ViewUsage
{
  /**
  ...
  public EList<String> getValuePart()
  {
    if (valuePart == null)
    {
      valuePart = new EDataTypeEList<String>(String.class, this, SysMLOCPackage.VIEW_USAGE__VALUE_PART);
    }
    return valuePart;
  }
