...
#define MODEL_GUID "{2dcb09bb-8bbd-409c-9951-0e6ae5f39502}"
...
extern void BouncingBall_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc BouncingBall_setupDataStruc
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realParameterData[0].attribute.start = 0.8;
