...
extern "C" {
#endif
const char *BouncingBall_res_linear_model_frame()
{
  return "model linearized_model \"BouncingBall_res\"\n"
...
const char *BouncingBall_res_linear_model_datarecovery_frame()
{
  return "model linearized_model \"BouncingBall_res\"\n"
  "  parameter Integer n = 2 \"number of states\";\n"
  "  parameter Integer m = 0 \"number of inputs\";\n"
