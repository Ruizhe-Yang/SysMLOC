...
model TLine2 "Lossless transmission line with characteristic impedance Z0, frequency F and normalized length NL" extends Modelica.Electrical.Analog.Interfaces.TwoPort;
...
protected parameter SI.Time TD = NL/F;
equation assert (Z0 > 0, "Z0 has to be positive");
