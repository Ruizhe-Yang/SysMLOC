...
expandable connector CellBus "Measurement signal bus for a single cell" extends Modelica.Icons.SignalSubBus;
...
annotation ( Documentation ( info = "<html><p>Measurement bus of a single cell.</p></html>" ) );
end CellBus;
