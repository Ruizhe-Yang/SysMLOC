...
expandable connector StackBusArrays "Measurement signal bus for a stack, arranged as matrices" extends Modelica.Icons.SignalBus;
...
annotation ( Documentation ( info = "<html><p>Measurement bus of a stack, containing arrays of measured values, arranged in a matrix <code>Ns</code> x <code>Np</code>the same way as the stack is built from cells.</p></html>" ) );
end StackBusArrays;
