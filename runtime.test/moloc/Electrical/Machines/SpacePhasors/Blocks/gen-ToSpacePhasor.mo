...
block ToSpacePhasor "Conversion of polyphase instantaneous values to space phasors" extends Modelica.Blocks.Interfaces.MIMO ( final nin = m , final nout = 2 );
