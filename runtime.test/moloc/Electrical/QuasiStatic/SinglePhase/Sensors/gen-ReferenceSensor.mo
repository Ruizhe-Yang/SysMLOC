...
model ReferenceSensor "Sensor of reference angle gamma" extends QuasiStatic.SinglePhase.Interfaces.AbsoluteSensor;
...
equation gamma = pin.reference.gamma;
annotation ( Documentation ( info = "<html><p>This sensor can be used to measure the reference angle.</p><h4>See also</h4><p><a href=\"modelica://Modelica.Electrical.QuasiStatic.SinglePhase.Sensors.FrequencySensor\">FrequencySensor</a>,
...
</p></html>" ) , Icon ( graphics = { Text( extent={{-30,-10},{30,-70}}, textColor={64,64,64}, textString="rad" ) , Line(points={{100,0},{70,0}}, color={0,0,127}) } ) );
end ReferenceSensor;
